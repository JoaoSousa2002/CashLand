(() => {
  ...
  var require_joi_browser_min = __commonJS({
    "node_modules/joi/dist/joi-browser.min.js"(exports, module) {
      !(function(e, t) {
        ...
        var e = { 2115(e2, t2, r2) {
          "use strict";
          const { assert: s, clone: n, deepEqual: a, merge: o } = r2(3115), i = r2(2130), l = r2(9415), c = r2(3541), u = r2(8013), f = r2(2062), m = r2(9017), h = r2(6162), p = r2(5844), d = r2(8529), g = r2(125), y = r2(1190), b = r2(6220), v = { standardTypes: /* @__PURE__ */ new Set(["string", "number", "integer", "boolean", "object", "array", "null"]), jsonSchemaTarget: "draft-2020-12", primitiveTypes: /* @__PURE__ */ new Set(["string", "number", "boolean"]), nullSchema: () => ({ type: "null" }), Base: class {
            constructor(e3) {
            ...
            $_jsonSchema(e3, t3 = {}) {
              var r3;
              if (void 0 !== t3.target && t3.target !== v.jsonSchemaTarget) throw new Error(`Unsupported JSON Schema target: ${t3.target}`);
              const s2 = !t3.$defs, n2 = null !== (r3 = t3.$defs) && void 0 !== r3 ? r3 : {};
              let o2 = {};
              const i2 = "any" === this.type, c2 = this._flags.only, u2 = this._valids && Array.from(this._valids._values).filter((e4) => null !== e4);
              let f2 = true;
              if (u2 && u2.length && c2 && !i2) {
                const e4 = new Set(u2.map((e5) => typeof e5));
                f2 = e4.has(this.type) || "date" === this.type && e4.has("object");
              }
              !i2 && f2 && v.standardTypes.has(this.type) && (o2.type = this.type), this._flags.description && (o2.description = this._flags.description), void 0 !== this._flags.default && "function" != typeof this._flags.default && (o2.default = this._flags.default);
              const m2 = { ...t3, $defs: n2 };
              this._definition.jsonSchema && f2 && (o2 = this._definition.jsonSchema(this, o2, e3, m2));
              for (const t4 of this._rules) {
                const r4 = this._definition.rules[t4.name];
                r4.jsonSchema && f2 && !t4._resolve.length && (o2 = r4.jsonSchema(t4, o2, c2, e3, m2));
              }
              if (this.$_terms.shared) for (const t4 of this.$_terms.shared) n2[t4._flags.id] = t4.$_jsonSchema(e3, m2);
              if (s2 && Object.keys(n2).length && (o2.$defs = n2), this._valids) {
                const e4 = u2.filter((e5) => "symbol" != typeof e5);
                if (e4.length) if (this._flags.only) {
                  o2.enum = e4;
                  const t4 = l.intersect(new Set(e4.map((e5) => typeof e5)), v.primitiveTypes);
                  if (t4.size) {
                    const e5 = [...t4];
                    o2.type = 1 === e5.length ? e5[0] : e5;
                  }
                } else {
                  const t4 = e4.filter((e5) => typeof e5 !== this.type || i2);
                  !t4.length || i2 && !c2 || (o2.anyOf || (o2 = { anyOf: [o2] }), o2.anyOf.push({ enum: t4 }));
                }
              }
              if (this._valids && this._valids.has(null) && (!i2 || c2) && (1 === this._valids.length && (i2 || c2) ? o2.type = "null" : o2.type ? o2.type = [o2.type, "null"] : o2.anyOf ? o2.anyOf.unshift(v.nullSchema()) : o2 = { anyOf: [v.nullSchema(), o2] }), this.$_terms.whens) {
                const t4 = this.clone();
                t4.$_terms.whens = null;
                const r4 = [];
                for (const s4 of this.$_terms.whens) {
                  const n3 = s4.is ? [s4] : s4.switch;
                  for (let s5 = 0; s5 < n3.length; ++s5) {
                    const a2 = n3[s5];
                    a2.then && r4.push(t4.concat(a2.then).$_jsonSchema(e3, m2)), a2.otherwise && r4.push(t4.concat(a2.otherwise).$_jsonSchema(e3, m2)), a2.then && (s5 !== n3.length - 1 || a2.otherwise) || r4.push(t4.$_jsonSchema(e3, m2));
                  }
                }
                const s3 = [];
                for (const e4 of r4) s3.some((t5) => a(t5, e4)) || s3.push(e4);
                return { anyOf: s3 };
              }
              return o2;
            }
            ...
            rule(e3) {
              ...
              const a2 = this.clone();
              for (let o2 = r3; o2 < a2._rules.length; ++o2) {
                const r4 = a2._rules[o2], i2 = n(r4);
                for (const n2 of Object.keys(e3)) t3.modifiers[n2](i2, e3[n2]), s(i2.name === r4.name, "Cannot change rule name");
                a2._rules[o2] = i2, a2._singleRules.get(i2.name) === r4 && a2._singleRules.set(i2.name, i2);
              }
            ...
            $_addRule(e3) {
              ...
              for (const t4 of Object.keys(e3)) s("_" !== t4[0], "Cannot set private rule properties");
              ...
              const a2 = this.clone();
              if (n2) {
                const e4 = Object.keys(n2);
                s(1 === e4.length || e4.length === this._definition.rules[t3.name].args.length, "Invalid rule definition for", this.type, t3.name);
                for (const o2 of e4) {
                  let e5 = n2[o2];
                  if (r3.argsByName) {
                    const i2 = r3.argsByName.get(o2);
                    if (i2.ref && l.isResolvable(e5)) t3._resolve.push(o2), a2.$_mutateRegister(e5);
                    else if (i2.normalize && (e5 = i2.normalize(e5), n2[o2] = e5), i2.assert) {
                      const t4 = l.validateArg(e5, o2, i2);
                      s(!t4, t4, "or reference");
                    }
                  }
                  void 0 !== e5 ? n2[o2] = e5 : delete n2[o2];
                }
              }
            ...
            $_createError(e3, t3, r3, s2, n2, a2 = {}) {
              ...
              return new u.Report(e3, t3, r3, o2, i2, s2, n2);
            }
            $_getFlag(e3) {
            ...
            $_setFlag(e3, t3, r3 = {}) {
              ...
              const o2 = false !== r3.clone ? this.clone() : this;
            ...
            _generate(e3, t3, r3) {
              ...
              for (let a3 = 0; a3 < this.$_terms.whens.length; ++a3) {
                ...
                if (o3.concat) {
                  s2.push(o3.concat), n2.push(`${a3}.concat`);
                  continue;
                }
                const i2 = o3.ref ? o3.ref.resolve(e3, t3, r3) : e3, l2 = o3.is ? [o3] : o3.switch, c2 = n2.length;
                for (let c3 = 0; c3 < l2.length; ++c3) {
                  const { is: u2, then: f2, otherwise: m2 } = l2[c3], h2 = `${a3}${o3.switch ? "." + c3 : ""}`;
                  if (u2.$_match(i2, t3.nest(u2, `${h2}.is`), r3)) {
                    if (f2) {
                      const a4 = t3.localize([...t3.path, `${h2}.then`], t3.ancestors, t3.schemas), { schema: o4, id: i3 } = f2._generate(e3, a4, r3);
                      s2.push(o4), n2.push(`${h2}.then${i3 ? `(${i3})` : ""}`);
                      break;
                    }
                  } else if (m2) {
                    const a4 = t3.localize([...t3.path, `${h2}.otherwise`], t3.ancestors, t3.schemas), { schema: o4, id: i3 } = m2._generate(e3, a4, r3);
                    s2.push(o4), n2.push(`${h2}.otherwise${i3 ? `(${i3})` : ""}`);
                    break;
                  }
                }
              ...
              let o2 = this;
              this._definition.generate && (o2 = this._definition.generate(this, e3, t3, r3));
            ...
            get "~standard"() {
              ...
              return { version: 1, vendor: "joi", validate: (r3, s2) => {
                const n2 = y.standard(r3, this, s2);
                return n2 instanceof Promise ? n2.then(t3, e3) : n2.error ? e3(n2.error) : t3(n2.value);
              }, jsonSchema: { input: (e4) => this.$_jsonSchema("input", e4), output: (e4) => this.$_jsonSchema("output", e4) } };
            }
          } };
          ...
          "use strict";
          const { assert: s, clone: n } = r2(3115), a = r2(9415), o = { max: 1e3, supported: /* @__PURE__ */ new Set(["undefined", "boolean", "number", "string"]) };
          ...
          }, t2.intersect = function(e3, t3) {
            if ("function" == typeof e3.intersection) return e3.intersection(t3);
            const r3 = /* @__PURE__ */ new Set();
            for (const s2 of e3) t3.has(s2) && r3.add(s2);
            return r3;
          ...
          t2.schema = function(e3, t3, r3 = {}) {
            ...
            if (Array.isArray(t3)) {
              for (const r4 of t3) if (!o.simple(r4)) return e3.alternatives().try(...t3);
              return a2(e3, ...t3);
            }
            ...
            const i = r3 && r3[n.symbols.any];
            if (i) return s(a2.legacy || i.version === n.version, "Cannot mix different versions of joi schemas:", i.version, n.version), r3;
            ...
            for (const t4 of Object.keys(e3)) {
              const r3 = o.walk(e3[t4]);
              if (r3) return r3;
            }
            return null;
          }, o.simple = function(e3) {
            return null === e3 || ["boolean", "string", "number"].includes(typeof e3);
          }, t2.when = function(e3, r3, i) {
            if (void 0 === i && (s(r3 && "object" == typeof r3, "Missing options"), i = r3, r3 = a.create(".")), Array.isArray(i) && (i = { switch: i }), n.assertOptions(i, ["is", "not", "then", "otherwise", "switch", "break"]), n.isSchema(r3)) return s(void 0 === i.is, '"is" can not be used with a schema condition'), s(void 0 === i.not, '"not" can not be used with a schema condition'), s(void 0 === i.switch, '"switch" can not be used with a schema condition'), o.condition(e3, { is: r3, then: i.then, otherwise: i.otherwise, break: i.break });
            if (s(a.isRef(r3) || "string" == typeof r3, "Invalid condition:", r3), s(void 0 === i.not || void 0 === i.is, 'Cannot combine "is" with "not"'), void 0 === i.switch) {
              let l2 = i;
            ...
            const l = { ref: t2.ref(r3), switch: [], break: i.break };
            for (let t3 = 0; t3 < i.switch.length; ++t3) {
              const r4 = i.switch[t3], o2 = t3 === i.switch.length - 1;
              n.assertOptions(r4, o2 ? ["is", "then", "otherwise"] : ["is", "then"]), s(void 0 !== r4.is, 'Switch statement missing "is"'), s(void 0 !== r4.then, 'Switch statement missing "then"');
              const c = { is: e3.$_compile(r4.is), then: e3.$_compile(r4.then) };
              if (a.isRef(r4.is) || n.isSchema(r4.is) || (c.is = c.is.required()), o2) {
                s(void 0 === i.otherwise || void 0 === r4.otherwise, 'Cannot specify "otherwise" inside and outside a "switch"');
                const t4 = void 0 !== i.otherwise ? i.otherwise : r4.otherwise;
          ...
          t2.Report = class {
            constructor(e3, r3, s2, n2, a2, o, i) {
              if (this.code = e3, this.flags = n2, this.messages = a2, this.path = o.path, this.prefs = i, this.state = o, this.value = r3, this.message = null, this.template = null, this.local = s2 || {}, this.local.label = t2.label(this.flags, this.state, this.prefs, this.messages), void 0 === this.value || this.local.hasOwnProperty("value") || (this.local.value = this.value), this.path.length) {
            ...
            if (n2) return n2;
            if (s2.errors.stack) return new t2.ValidationError(a2, o, r3);
            const i = Error.stackTraceLimit;
            Error.stackTraceLimit = 0;
            const l = new t2.ValidationError(a2, o, r3);
          ...
          "use strict";
          const { assert: s, clone: n } = r2(3115), a = r2(9415), o = r2(6162), i = {};
          t2.type = function(e3, t3) {
            ...
            if (u.terms) for (const e4 of Object.keys(u.terms)) {
              const t4 = u.terms[e4];
            ...
            if (u.rules) for (const e4 of Object.keys(u.rules)) {
              const t4 = u.rules[e4];
              s("object" == typeof t4, "Invalid rule definition for", u.type, e4);
              let r4 = t4.method;
              if (void 0 === r4 && (r4 = function() {
                return this.$_addRule(e4);
              }), r4 && (s(!l[e4], "Rule conflict in", u.type, e4), l[e4] = r4), s(!h[e4], "Rule conflict in", u.type, e4), h[e4] = t4, t4.alias) {
            ...
            if (u.modifiers) for (const e4 of Object.keys(u.modifiers)) {
            ...
            if (u.modifiers = p, u.overrides) {
              ...
              for (const e4 of Object.keys(u.overrides)) s(r3[e4], "Cannot override missing", e4), u.overrides[e4][a.symbols.parent] = r3[e4], c.$_super[e4] = r3[e4].bind(c);
          ...
          "use strict";
          const { assert: s, clone: n } = r2(3115), a = r2(2130), o = r2(9415), i = r2(3541), l = r2(8013), c = r2(2062), u = r2(9017), f = r2(8529), m = r2(1532), h = r2(125);
          let p;
          const d = { types: { alternatives: r2(4972), any: r2(680), array: r2(2591), boolean: r2(6186), date: r2(2588), function: r2(4840), link: r2(9556), number: r2(4709), object: r2(7487), string: r2(9033), symbol: r2(5008) }, aliases: { alt: "alternatives", bool: "boolean", func: "function" }, root: function() {
            ...
            for (const t3 of Object.keys(d.aliases)) {
              const r3 = d.aliases[t3];
              e3[t3] = e3[r3];
            }
            return e3.x = e3.expression, h.setup && h.setup(e3), e3;
          } };
          d.methods = { ValidationError: l.ValidationError, version: o.version, cache: a.provider, assert(e3, t3, ...r3) {
            ...
            for (const r3 of t3._types) {
              const n2 = e3(t3[r3]());
              s(o.isSchema(n2), "modifier must return a valid schema object"), t3[r3] = function(...e4) {
                return d.generate(this, n2, e4);
              };
            }
            return t3;
          }, expression: (...e3) => new m(...e3), extend(...e3) {
            o.verifyFlat(e3, "extend"), p = p || r2(1688), s(e3.length, "You need to provide at least one extension"), this.assert(e3, p.extensions);
            const t3 = Object.assign({}, this);
            ...
            for (const t3 of Object.keys(d.aliases)) e3[t3] = this[t3]();
            return e3;
          } }, d.assert = function(e3, t3, r3, s2) {
            const a2 = s2[0] instanceof Error || "string" == typeof s2[0] ? s2[0] : null, i2 = null !== a2 ? s2[1] : s2[0], c2 = t3.validate(e3, o.preferences({ errors: { stack: true } }, i2 || {}));
            let u2 = c2.error;
          ...
          t2.compile = function(e3, t3) {
            ...
            for (const r3 of Object.keys(e3)) {
              ...
              if ("root" === r3 || a.isTemplate(n2)) {
                s("__proto__" !== r3, "Cannot use __proto__ as a message code"), t3[r3] = n2;
                continue;
              }
              if ("string" == typeof n2) {
                s("__proto__" !== r3, "Cannot use __proto__ as a message code"), t3[r3] = new a(n2);
                continue;
              }
              s("object" == typeof n2 && !Array.isArray(n2), "Invalid message for", r3);
              const o = r3, i = Object.hasOwn(t3, o) ? t3[o] : {};
              t3[o] = i;
              for (const e4 of Object.keys(n2)) {
                const t4 = n2[e4];
                s("__proto__" !== e4, "Cannot use __proto__ as a message code"), "root" === e4 || a.isTemplate(t4) ? i[e4] = t4 : (s("string" == typeof t4, "Invalid message for", e4, "in", o), i[e4] = new a(t4));
              }
            }
            return t3;
            ...
            for (const r3 of Object.keys(e3)) {
              ...
              for (const e4 of Object.keys(s2)) {
                const r4 = s2[e4];
                "root" !== e4 ? t3[n2][e4] = r4.describe({ compact: true }) : t3[n2].root = r4;
              }
            }
            return t3;
            ...
            for (const e4 of Object.keys(r3)) {
              ...
              if ("root" === e4 || a.isTemplate(t3)) {
                s("__proto__" !== e4, "Cannot use __proto__ as a message code"), o[e4] = t3;
                continue;
              }
              if ("string" == typeof t3) {
                s("__proto__" !== e4, "Cannot use __proto__ as a message code"), o[e4] = new a(t3);
                continue;
              }
              s("object" == typeof t3 && !Array.isArray(t3), "Invalid message for", e4);
              const n2 = e4, i = Object.hasOwn(o, n2) ? o[n2] : {};
              o[n2] = i;
              for (const e5 of Object.keys(t3)) {
                const r4 = t3[e5];
                s("__proto__" !== e5, "Cannot use __proto__ as a message code"), "root" === e5 || a.isTemplate(r4) ? i[e5] = r4 : (s("string" == typeof r4, "Invalid message for", e5, "in", n2), i[e5] = new a(r4));
              }
            }
            return o;
          };
          ...
          t2.Ids = o.Ids = class {
            ...
            clone() {
              const e3 = new o.Ids();
              return this._byId.size && (e3._byId = new Map(this._byId)), this._byKey.size && (e3._byKey = new Map(this._byKey)), e3._schemaChain = this._schemaChain, e3;
            }
            concat(e3) {
            ...
            fork(e3, t3, r3) {
              ...
              a2.push({ schema: r3 });
              const i = a2.shift();
              let l = { id: i.id, schema: t3(i.schema) };
              s(n.isSchema(l.schema), "adjuster function failed to return a joi schema type");
              for (const e4 of a2) l = { id: e4.id, schema: o.fork(e4.schema, l.id, l.schema) };
              return l.schema;
            }
            labels(e3, t3 = []) {
            ...
            _collect(e3, t3 = [], r3 = []) {
              ...
              const o2 = e3.slice(1);
              return o2.length ? a2.schema._ids._collect(o2, [...t3, n2], r3) : r3;
            }
            _get(e3) {
              return this._byId.get(e3) || this._byKey.get(e3);
            }
          }, o.fork = function(e3, r3, s2) {
            ...
            let r3;
            for (const s2 of Object.keys(e3._flags)) {
              if ("_" === s2[0]) continue;
              const n2 = o.scan(e3._flags[s2], { source: "flags", name: s2 }, t3);
              void 0 !== n2 && (r3 = r3 || e3.clone(), r3._flags[s2] = n2);
            }
            for (let s2 = 0; s2 < e3._rules.length; ++s2) {
              const n2 = e3._rules[s2], a2 = o.scan(n2.args, { source: "rules", name: n2.name }, t3);
              if (void 0 !== a2) {
                r3 = r3 || e3.clone();
            ...
            for (const s2 of Object.keys(e3.$_terms)) {
              if ("_" === s2[0]) continue;
              const n2 = o.scan(e3.$_terms[s2], { source: "terms", name: s2 }, t3);
              void 0 !== n2 && (r3 = r3 || e3.clone(), r3.$_terms[s2] = n2);
            }
            return r3;
          }, o.scan = function(e3, t3, r3, s2, i) {
            const l = s2 || [];
            if (null === e3 || "object" != typeof e3) return;
            let c;
            if (Array.isArray(e3)) {
              for (let s3 = 0; s3 < e3.length; ++s3) {
                const n2 = "terms" === t3.source && "keys" === t3.name && e3[s3].key, a2 = o.scan(e3[s3], t3, r3, [s3, ...l], n2);
                void 0 !== a2 && (c = c || e3.slice(), c[s3] = a2);
              }
              return c;
            }
            if (false !== r3.schema && n.isSchema(e3) || false !== r3.ref && a.isRef(e3)) {
              const s3 = r3.each(e3, { ...t3, path: l, key: i });
              if (s3 === e3) return;
              return s3;
            }
            for (const s3 of Object.keys(e3)) {
              if ("_" === s3[0]) continue;
              const n2 = o.scan(e3[s3], t3, r3, [s3, ...l], i);
          ...
          "use strict";
          const { assert: s, reach: n } = r2(3115), a = r2(9415);
          let o;
          const i = { symbol: /* @__PURE__ */ Symbol("ref"), defaults: { adjust: null, in: false, iterables: null, map: null, separator: ".", type: "value" } };
          t2.create = function(e3, t3 = {}) {
            s("string" == typeof e3, "Invalid reference key:", e3), a.assertOptions(t3, ["adjust", "ancestor", "in", "iterables", "map", "prefix", "render", "separator"]), s(!t3.prefix || "object" == typeof t3.prefix, "options.prefix must be of type object");
            const r3 = Object.assign({}, i.defaults, t3);
            delete r3.prefix;
            const n2 = r3.separator, o2 = i.context(e3, n2, t3.prefix);
            if (r3.type = o2.type, e3 = o2.key, "value" === r3.type) if (o2.root && (s(!n2 || e3[0] !== n2, "Cannot specify relative path with root prefix"), r3.ancestor = "root", e3 || (e3 = null)), n2 && n2 === e3) e3 = null, r3.ancestor = 0;
            else if (void 0 !== r3.ancestor) s(!n2 || !e3 || e3[0] !== n2, "Cannot combine prefix with ancestor option");
            else {
              const [t4, s2] = i.ancestor(e3, n2);
              s2 && "" === (e3 = e3.slice(s2)) && (e3 = null), r3.ancestor = t4;
            }
            return r3.path = n2 ? null === e3 ? [] : e3.split(n2) : [e3], new i.Ref(r3);
          }, t2.in = function(e3, r3 = {}) {
            return t2.create(e3, { ...r3, in: true });
          }, t2.isRef = function(e3) {
            return !!e3 && !!e3[a.symbols.ref];
          }, i.Ref = class {
            constructor(e3) {
              s("object" == typeof e3, "Invalid reference construction"), a.assertOptions(e3, ["adjust", "ancestor", "in", "iterables", "map", "path", "render", "separator", "type", "depth", "key", "root", "display"]), s([false, void 0].includes(e3.separator) || "string" == typeof e3.separator && 1 === e3.separator.length, "Invalid separator"), s(!e3.adjust || "function" == typeof e3.adjust, "options.adjust must be a function"), s(!e3.map || Array.isArray(e3.map), "options.map must be an array"), s(!e3.map || !e3.adjust, "Cannot set both map and adjust options"), Object.assign(this, i.defaults, e3), s("value" === this.type || void 0 === this.ancestor, "Non-value references cannot reference ancestors"), Array.isArray(this.map) && (this.map = new Map(this.map)), this.depth = this.path.length, this.key = this.path.length ? this.path.join(this.separator) : null, this.root = this.path[0], this.updateDisplay();
            }
            ...
            _resolve(e3, t3, r3) {
              let s2;
              if ("value" === this.type && t3.mainstay.shadow && false !== r3.shadow && (s2 = t3.mainstay.shadow.get(this.absolute(t3))), void 0 === s2 && (s2 = n(e3, this.path, { iterables: this.iterables, functions: true })), this.adjust && (s2 = this.adjust(s2)), this.map) {
          ...
          }, i.Ref.prototype[a.symbols.ref] = true, t2.build = function(e3) {
            return "value" === (e3 = Object.assign({}, i.defaults, e3)).type && void 0 === e3.ancestor && (e3.ancestor = 1), new i.Ref(e3);
          }, i.context = function(e3, t3, r3 = {}) {
            if (e3 = e3.trim(), r3) {
            ...
            register(e3, s2) {
              ...
              else if (a.isSchema(e3)) for (const t3 of e3._refs.refs) t3.ancestor - s2 >= 0 && this.refs.push({ ancestor: t3.ancestor - s2, root: t3.root });
            ...
            clone() {
              ...
              return e3.refs = this.refs.slice(), e3;
            }
            reset() {
              this.refs = [];
            }
          ...
          e2.exports = o.State = class {
            ...
            localize(e3, t3 = null, r3 = null) {
              ...
              return r3 && s2.schemas && (s2.schemas = [o.schemas(r3), ...s2.schemas]), s2;
            }
            nest(e3, t3) {
              const r3 = new o.State(this.path, this.ancestors, this);
              return r3.schemas = r3.schemas && [o.schemas(e3), ...r3.schemas], r3.debug = t3, r3;
            }
            shadow(e3, t3) {
          ...
          "use strict";
          const { assert: s, clone: n, escapeHtml: a } = r2(3115), o = r2(679), i = r2(9415), l = r2(8013), c = r2(8529), u = { symbol: /* @__PURE__ */ Symbol("template"), opens: new Array(1e3).join("\0"), closes: new Array(1e3).join(""), dateFormat: { date: Date.prototype.toDateString, iso: Date.prototype.toISOString, string: Date.prototype.toString, time: Date.prototype.toTimeString, utc: Date.prototype.toUTCString } };
          e2.exports = u.Template = class {
            ...
            _parse() {
              ...
              for (const e4 of t3) {
                ...
                const i2 = ":" === o2[0];
                i2 && (o2 = o2.slice(1));
                const l2 = this._ref(u.decode(o2), { raw: t4, wrapped: i2 });
            ...
            static isTemplate(e3) {
              return !!e3 && !!e3[i.symbols.template];
            }
            refs() {
            ...
            render(e3, t3, r3, s2, n2 = {}) {
              ...
              const o2 = [];
              for (const i2 of this._template) if ("string" == typeof i2) o2.push(i2);
              else {
                const l2 = this._part(i2, e3, t3, r3, s2, n2), c2 = u.stringify(l2, e3, t3, r3, s2, n2);
                if (void 0 !== c2) {
                  const e4 = i2.raw || false === (n2.errors && n2.errors.escapeHtml) ? c2 : a(c2);
                  o2.push(u.wrap(e4, i2.wrapped && r3.errors.wrap.label));
                }
              }
              return o2.join("");
            }
            _ref(e3, { raw: t3, wrapped: r3 }) {
              ...
              try {
                ...
                var a2 = new o.Parser(e3, { reference: n2, functions: t4, constants: u.constants });
              } catch (t4) {
          ...
          }, u.Template.prototype[i.symbols.template] = true, u.Template.prototype.isImmutable = true, u.encode = function(e3) {
            ...
            const o2 = typeof e3, i2 = s2 && s2.errors && s2.errors.wrap || {};
            let l2 = false;
            if (c.isRef(e3) && e3.render && (l2 = e3.in, e3 = e3.resolve(t3, r3, s2, n2, { in: e3.in, ...a2 })), null === e3) return "null";
            if ("string" === o2) return u.wrap(e3, a2.arrayItems && i2.string);
            if ("number" === o2 || "function" === o2 || "symbol" === o2) return e3.toString();
            if ("object" !== o2) return JSON.stringify(e3);
            ...
            const f = [];
            for (const o3 of e3) f.push(u.stringify(o3, t3, r3, s2, n2, { arrayItems: true, ...a2 }));
            return u.wrap(f.join(", "), !l2 && i2.array);
            ...
            const [t3, r3, s2, n2, a2] = this, o2 = a2.messages;
            if (!o2) return "";
            const i2 = l.template(t3, o2[0], e3, r3, s2) || l.template(t3, o2[1], e3, r3, s2);
            return i2 ? i2.render(t3, r3, s2, n2, a2) : "";
          }, number: (e3) => "number" == typeof e3 ? e3 : "string" == typeof e3 ? parseFloat(e3) : "boolean" == typeof e3 ? e3 ? 1 : 0 : e3 instanceof Date ? e3.getTime() : null };
        }, 4972(e2, t2, r2) {
          "use strict";
          const { assert: s, merge: n } = r2(3115), a = r2(680), o = r2(9415), i = r2(3541), l = r2(8013), c = r2(8529), u = {};
          e2.exports = a.extend({ type: "alternatives", flags: { match: { default: "any" } }, terms: { matches: { init: [], register: c.toSibling } }, args: (e3, ...t3) => 1 === t3.length && Array.isArray(t3[0]) ? e3.try(...t3[0]) : e3.try(...t3), validate(e3, t3) {
            const { schema: r3, error: s2, state: a2, prefs: o2 } = t3;
            if (r3._flags.match) {
              const t4 = [], i3 = [];
              for (let s3 = 0; s3 < r3.$_terms.matches.length; ++s3) {
                ...
                c3.errors ? (i3.push(c3.errors), l2.restore()) : (t4.push(c3.value), l2.commit());
              }
              if (0 === t4.length) return { errors: s2("alternatives.any", { details: i3.map((e4) => l.details(e4, { override: false })) }) };
              if ("one" === r3._flags.match) return 1 === t4.length ? { value: t4[0] } : { errors: s2("alternatives.one") };
              if (t4.length !== r3.$_terms.matches.length) return { errors: s2("alternatives.all", { details: i3.map((e4) => l.details(e4, { override: false })) }) };
            ...
            for (let t4 = 0; t4 < r3.$_terms.matches.length; ++t4) {
              ...
              if (s3.schema) {
                ...
                r4.snapshot();
                const n3 = s3.schema.$_validate(e3, r4, o2);
                if (!n3.errors) return r4.commit(), n3;
                r4.restore(), i2.push({ schema: s3.schema, reports: n3.errors });
                continue;
              }
              const n2 = s3.ref ? s3.ref.resolve(e3, a2, o2) : e3, l2 = s3.is ? [s3] : s3.switch;
              for (let r4 = 0; r4 < l2.length; ++r4) {
                const i3 = l2[r4], { is: c2, then: u2, otherwise: f } = i3, m = `match.${t4}${s3.switch ? "." + r4 : ""}`;
                if (c2.$_match(n2, a2.nest(c2, `${m}.is`), o2)) {
                  if (u2) return u2.$_validate(e3, a2.nest(u2, `${m}.then`), o2);
                } else if (f) return f.$_validate(e3, a2.nest(f, `${m}.otherwise`), o2);
              }
            }
            return u.errors(i2, t3);
          }, jsonSchema(e3, t3, r3, s2) {
            const n2 = [];
            for (const t4 of e3.$_terms.matches) if (t4.schema) n2.push(t4.schema.$_jsonSchema(r3, s2));
            else {
              const e4 = t4.is ? [t4] : t4.switch;
              for (const t5 of e4) t5.then && n2.push(t5.then.$_jsonSchema(r3, s2)), t5.otherwise && n2.push(t5.otherwise.$_jsonSchema(r3, s2));
            }
            if (n2.length) {
              var a2;
              delete t3.type;
              const r4 = null !== (a2 = e3._flags.match) && void 0 !== a2 ? a2 : "any";
              "one" === r4 ? t3.oneOf = n2 : "all" === r4 ? t3.allOf = n2 : t3.anyOf = n2;
            }
            return t3;
            ...
            const r3 = this.clone(), n2 = i.when(r3, e3, t3), a2 = n2.is ? [n2] : n2.switch;
            ...
            if (t3.matches) for (const r3 of t3.matches) {
              const { schema: t4, ref: s2, is: n2, not: a2, then: o2, otherwise: i2 } = r3;
              e3 = t4 ? e3.try(t4) : s2 ? e3.conditional(s2, { is: n2, then: o2, not: a2, otherwise: i2, switch: r3.switch }) : e3.conditional(n2, { then: o2, otherwise: i2 });
            }
            return e3;
            ...
            for (const { reports: a2, schema: o2 } of e3) {
              ...
              if (i2.state.path.length !== r3.path.length) {
              ...
              "base" !== f ? n2.push({ type: o2.type, report: i2 }) : "object.base" === i2.code ? s2.add(i2.local.type) : s2.add(c2);
            }
          ...
          "use strict";
          const { assert: s } = r2(3115), n = r2(2115), a = r2(9415), o = r2(6162);
            ...
            for (const r3 of Object.keys(t3)) {
              ...
              if (["examples", "externals", "metas", "notes", "tags"].includes(r3)) for (const t4 of s2) e3 = e3[r3.slice(0, -1)](t4);
                ...
                if ("whens" !== r3) {
                  ...
                  const { ref: r4, is: s3, not: n2, then: a2, otherwise: o2, concat: i } = t4;
                  e3 = i ? e3.concat(i) : r4 ? e3.when(r4, { is: s3, not: n2, then: a2, otherwise: o2, switch: t4.switch, break: t4.break }) : e3.when(s3, { then: a2, otherwise: o2, break: t4.break });
                }
              }
            }
            return e3;
          ...
          "use strict";
          const { assert: s, deepEqual: n, reach: a } = r2(3115), o = r2(680), i = r2(9415), l = r2(3541), c = {};
          e2.exports = o.extend({ type: "array", flags: { single: { default: false }, sparse: { default: false } }, terms: { items: { init: [], manifest: "schema" }, ordered: { init: [], manifest: "schema" }, _exclusions: { init: [] }, _inclusions: { init: [] }, _requireds: { init: [] } }, coerce: { from: "object", method(e3, { schema: t3, state: r3, prefs: s2 }) {
            ...
            const n2 = e3.$_terms.ordered;
            if (n2.length && (t3.prefixItems = n2.map((e4) => e4.$_jsonSchema(r3, s2))), e3.$_terms.items.length) {
              let a3;
              a3 = 1 === e3.$_terms.items.length ? e3.$_terms.items[0].$_jsonSchema(r3, s2) : { anyOf: e3.$_terms.items.map((e4) => e4.$_jsonSchema(r3, s2)) }, n2.length ? (t3.unevaluatedItems = a3, c.setOrderedMinItems(t3, n2)) : t3.items = a3;
            } else n2.length && (t3.unevaluatedItems = false, c.setOrderedMinItems(t3, n2), t3.maxItems = n2.length);
            const a2 = [];
            for (const t4 of e3._rules) "has" !== t4.name || t4.args.schema._refs.refs.length || a2.push(t4.args.schema.$_jsonSchema(r3, s2));
            if (a2.length && (1 === a2.length ? t3.contains = a2[0] : t3.allOf = a2.map((e4) => ({ contains: e4 }))), e3._flags.single && e3.$_terms.items.length) {
              let n3;
              n3 = 1 === e3.$_terms.items.length ? e3.$_terms.items[0].$_jsonSchema(r3, s2) : { anyOf: e3.$_terms.items.map((e4) => e4.$_jsonSchema(r3, s2)) }, t3 = { anyOf: [t3, n3] };
            }
            return t3;
          }, rules: { has: { method(e3) {
            ...
            for (let s3 = 0; s3 < e3.length; ++s3) {
              ...
              if (n2.$_match(e3[s3], o3, r3)) return e3;
            }
            ...
            for (let r3 = 0; r3 < e3.length; ++r3) {
              const s2 = i.tryWithPath(() => this.$_compile(e3[r3]), r3, { append: true });
            ...
            for (let a3 = 0; a3 < h; ++a3) {
              ...
              if (!t3._flags.sparse && void 0 === i2) {
                if (m.push(r3("array.sparse", { key: g, path: y, pos: a3, value: void 0 }, s2.localize(y))), n2.abortEarly) return m;
                l2.shift();
                continue;
              }
              const b = [e3, ...s2.ancestors];
              for (const e4 of t3.$_terms._exclusions) if (e4.$_match(i2, s2.localize(y, b, e4), n2, { presence: "ignore" })) {
                if (m.push(r3("array.excludes", { pos: a3, value: i2 }, s2.localize(y))), n2.abortEarly) return m;
                p = true, l2.shift();
                break;
              }
              if (p) continue;
              if (t3.$_terms.ordered.length) {
                ...
                if (!t3.$_terms.items.length) {
                  if (m.push(r3("array.orderedLength", { pos: a3, limit: t3.$_terms.ordered.length })), n2.abortEarly) return m;
                  break;
                }
              }
              const v = [];
              ...
              for (let l3 = 0; l3 < _; ++l3) {
                ...
                if (v[l3] = f2, !f2.errors) {
                  if (u2.commit(), e3[a3] = f2.value, d = true, c.fastSplice(o2, l3), --l3, --_, !t3._flags.sparse && void 0 === f2.value && (m.push(r3("array.sparse", { key: g, path: y, pos: a3, value: void 0 }, s2.localize(y))), n2.abortEarly)) return m;
                  break;
                }
                u2.restore();
              }
              ...
              for (const l3 of u) {
                ...
                if (-1 !== f2) u2 = v[f2];
                  ...
                  if (o3.snapshot(), u2 = l3.$_validate(i2, o3, n2), !u2.errors) {
                    o3.commit(), "strip" === l3._flags.result ? (c.fastSplice(e3, a3), --a3, --h) : t3._flags.sparse || void 0 !== u2.value ? e3[a3] = u2.value : (m.push(r3("array.sparse", { key: g, path: y, pos: a3, value: void 0 }, s2.localize(y))), p = true), d = true;
                    break;
                  }
                  o3.restore();
                }
                if (1 === _) {
                  if (A) {
                    c.fastSplice(e3, a3), --a3, --h, d = true;
                    break;
                  }
                  if (m.push(...u2.errors), n2.abortEarly) return m;
                  p = true;
              ...
              if (!p && (t3.$_terms._inclusions.length || t3.$_terms._requireds.length) && !d) {
                ...
                if (m.push(r3("array.includes", { pos: a3, value: i2 }, s2.localize(y))), n2.abortEarly) return m;
              }
            }
          ...
          }, validate: (e3, t3, { limit: r3 }, { name: s2, operator: n2, args: a2 }) => i.compare(e3.length, r3, n2) ? e3 : t3.error("array." + s2, { limit: a2.limit, value: e3 }), jsonSchema: (e3, t3) => (t3.minItems = e3.args.limit, t3.maxItems = e3.args.limit, t3), args: [{ name: "limit", ref: true, assert: i.limit, message: "must be a positive integer" }] }, max: { method(e3) {
            return this.$_addRule({ name: "max", method: "length", args: { limit: e3 }, operator: "<=" });
          }, jsonSchema: (e3, t3) => (t3.maxItems = e3.args.limit, t3) }, min: { method(e3) {
            return this.$_addRule({ name: "min", method: "length", args: { limit: e3 }, operator: ">=" });
          }, jsonSchema: (e3, t3) => (t3.minItems = e3.args.limit, t3) }, ordered: { method(...e3) {
            ...
            const { value: o2, errors: i2 } = c.sort(n2, e3, a2, r3, s2);
            if (i2) return i2;
            for (let r4 = 0; r4 < e3.length; ++r4) if (e3[r4] !== o2[r4]) return t3("array.sort", { order: a2.order, by: a2.by ? a2.by.key : "value" });
            return e3;
          ...
          }, validate(e3, { state: t3, error: r3, schema: o2 }, { comparator: i2, options: l2 }, { comparator: c2, path: u }) {
            ...
            for (let n2 = 0; n2 < e3.length; ++n2) {
              ...
              if (s(l3, "Failed to find unique map container for type", typeof o3), l3 instanceof Map) {
                ...
                for (; !(a2 = s2.next()).done; ) if (m(a2.value[0], o3)) {
                  ...
                  return u && (o4.path = i2), r3("array.unique", o4, s3);
                }
                l3.set(o3, n2);
              } else {
                if ((!h || void 0 !== o3) && void 0 !== l3[o3]) {
                  const s2 = { pos: n2, value: e3[n2], dupePos: l3[o3], dupeValue: e3[l3[o3]] };
                  return u && (s2.path = i2), r3("array.unique", s2, t3.localize([...t3.path, n2], [e3, ...t3.ancestors]));
                }
                l3[o3] = n2;
              }
            }
            return e3;
          }, jsonSchema: (e3, t3) => (e3.args.comparator || (t3.uniqueItems = true), t3), args: ["comparator", "options"], multi: true } }, overrides: { isAsync() {
            var e3;
            if (null !== (e3 = this.$_terms.externals) && void 0 !== e3 && e3.length) return true;
            ...
            const o2 = [];
            for (const e4 of r3) "required" === e4._flags.presence && o2.push(e4);
            o2.length && c.fillMissedErrors(e3, t3, o2, s2, n2, a2);
          }, c.fillDefault = function(e3, t3, r3, s2) {
            const n2 = [];
            let a2 = true;
            for (let o2 = e3.length - 1; o2 >= 0; --o2) {
              const i2 = e3[o2], l2 = [t3, ...r3.ancestors], c2 = i2.$_validate(void 0, r3.localize(r3.path, l2, i2), s2).value;
              if (a2) {
            ...
            const a2 = "ascending" === r3.order ? 1 : -1, o2 = -1 * a2, i2 = a2, l2 = (l3, u) => {
              let f = c.compare(l3, u, o2, i2);
              if (null !== f) return f;
              if (r3.by && (l3 = r3.by.resolve(l3, s2, n2), u = r3.by.resolve(u, s2, n2)), f = c.compare(l3, u, o2, i2), null !== f) return f;
              const m = typeof l3;
          ...
          "use strict";
          const { assert: s } = r2(3115), n = r2(680), a = r2(9415), o = r2(6220), i = { isBool: function(e3) {
          ...
          e2.exports = n.extend({ type: "boolean", flags: { sensitive: { default: false } }, terms: { falsy: { init: null, manifest: "values" }, truthy: { init: null, manifest: "values" } }, coerce(e3, { schema: t3 }) {
            if ("boolean" != typeof e3) {
              if ("string" == typeof e3) {
                const r3 = e3.trim(), s2 = t3._flags.sensitive ? r3 : r3.toLowerCase();
                e3 = "true" === s2 || "false" !== s2 && e3;
              }
          ...
          "use strict";
          const { assert: s } = r2(3115), n = r2(680), a = r2(9415), o = r2(1532), i = { formats: ["iso", "javascript", "unix"], isDate: function(e3) {
            return e3 instanceof Date;
          } };
          e2.exports = n.extend({ type: "date", coerce: { from: ["number", "string"], method: (e3, { schema: t3 }) => ({ value: i.parse(e3, t3._flags.format) || e3 }) }, validate(e3, { schema: t3, error: r3, prefs: s2 }) {
          ...
          }, jsonSchema: (e3, t3, r3, s2) => (t3.type = "string", t3.format = "date-time", t3), rules: { compare: { method: false, validate(e3, t3, { date: r3 }, { name: s2, operator: n2, args: o2 }) {
            const i2 = "now" === r3 ? Date.now() : r3.getTime();
            return a.compare(e3.getTime(), i2, n2) ? e3 : t3.error("date." + s2, { limit: o2.date, value: e3 });
          }, args: [{ name: "date", ref: true, normalize: (e3) => "now" === e3 ? e3 : i.parse(e3), assert: (e3) => null !== e3, message: "must have a valid date format" }] }, format: { method(e3) {
            return s(i.formats.includes(e3), "Unknown date format", e3), this.$_setFlag("format", e3);
          } }, greater: { method(e3) {
            return this.$_addRule({ name: "greater", method: "compare", args: { date: e3 }, operator: ">" });
          }, jsonSchema(e3, t3) {
            const r3 = e3.args.date;
            return r3 instanceof Date && (t3["x-constraint"] = { ...t3["x-constraint"], greater: r3.toISOString() }), t3;
          } }, iso: { method() {
            ...
            const r3 = e3.args.date;
            return r3 instanceof Date && (t3["x-constraint"] = { ...t3["x-constraint"], less: r3.toISOString() }), t3;
          } }, max: { method(e3) {
            return this.$_addRule({ name: "max", method: "compare", args: { date: e3 }, operator: "<=" });
          }, jsonSchema(e3, t3) {
            const r3 = e3.args.date;
            return r3 instanceof Date && (t3["x-constraint"] = { ...t3["x-constraint"], max: r3.toISOString() }), t3;
          } }, min: { method(e3) {
            return this.$_addRule({ name: "min", method: "compare", args: { date: e3 }, operator: ">=" });
          }, jsonSchema(e3, t3) {
            const r3 = e3.args.date;
            return r3 instanceof Date && (t3["x-constraint"] = { ...t3["x-constraint"], min: r3.toISOString() }), t3;
          ...
          "use strict";
          const { applyToDefaults: s, assert: n, clone: a } = r2(3115), o = r2(8248), i = r2(680), l = r2(9415), c = r2(3541), u = r2(8013), f = r2(8529), m = r2(1532), h = { renameDefaults: { alias: false, multiple: false, override: false } };
          e2.exports = i.extend({ type: "_keys", properties: { typeof: "object" }, flags: { unknown: { default: void 0 } }, terms: { dependencies: { init: null }, keys: { init: null, manifest: { mapped: { from: "schema", to: "key" } } }, patterns: { init: null }, renames: { init: null } }, args: (e3, t3) => e3.keys(t3), jsonSchema(e3, t3, r3, s2) {
            if (t3.type = "object", e3.$_terms.keys) {
              t3.properties = {};
              const n2 = [];
              for (const a2 of e3.$_terms.keys) {
                const e4 = a2.schema.$_jsonSchema(r3, s2);
                t3.properties[a2.key] = e4, a2.schema._flags.id && (s2.$defs[a2.schema._flags.id] = e4), ("required" === a2.schema._flags.presence || "output" === r3 && void 0 !== a2.schema._flags.default) && n2.push(a2.key);
              }
              n2.length && (t3.required = n2.sort());
            }
            if (e3.$_terms.patterns) {
              const n2 = {};
              for (const a2 of e3.$_terms.patterns) a2.regex ? n2[a2.regex.source] = a2.rule.$_jsonSchema(r3, s2) : "any" === a2.schema.type ? t3.additionalProperties = a2.rule.$_jsonSchema(r3, s2) : n2[".*"] = a2.rule.$_jsonSchema(r3, s2);
              Object.keys(n2).length && (t3.patternProperties = n2);
            }
            return void 0 === t3.additionalProperties && false == (true === e3._flags.unknown || void 0 === e3._flags.unknown && !e3.$_terms.keys && !e3.$_terms.patterns && !e3._flags.only) && (t3.additionalProperties = false), t3;
          }, validate(e3, { schema: t3, error: r3, state: s2, prefs: n2 }) {
            ...
            if (t3.$_terms.keys) {
              ...
              for (const i2 of t3.$_terms.keys) {
                ...
                o2.delete(t4);
                const c2 = s2.localize([...s2.path, t4], r4, i2), u2 = i2.schema.$_validate(l2, c2, n2);
                if (u2.errors) {
            ...
            if (o2.size || t3._flags._hasPatternMatch) {
              const r4 = h.unknown(t3, e3, o2, a2, s2, n2);
              if (r4) return r4;
            }
            if (t3.$_terms.dependencies) for (const r4 of t3.$_terms.dependencies) {
              if (null !== r4.key && false === h.isPresent(r4.options)(r4.key.resolve(e3, s2, n2, null, { shadow: false }))) continue;
              const o3 = h.dependencies[r4.rel](t3, r4, e3, s2, n2);
              if (o3) {
                const r5 = t3.$_createError(o3.code, e3, o3.context, s2, n2);
            ...
            m.isTemplate(e3) || (e3 = c.ref(e3)), n(void 0 === r3 || "string" == typeof r3, "Message must be a string"), t3 = this.$_compile(t3, { appendPath: true });
          ...
          }, validate(e3, { error: t3, prefs: r3, state: s2 }, { subject: n2, schema: a2, message: o2 }) {
            const i2 = n2.resolve(e3, s2, r3), l2 = f.isRef(n2) ? n2.absolute(s2) : [];
            return a2.$_match(i2, s2.localize(l2, [e3, ...s2.ancestors], a2), r3) ? e3 : t3("object.assert", { subject: n2, message: o2 });
            ...
            if (e3) if (Object.keys(e3).length) {
              ...
              for (const r3 of Object.keys(e3)) l.tryWithPath(() => t3.$_terms.keys.push({ key: r3, schema: this.$_compile(e3[r3]) }), r3);
            } else t3.$_terms.keys = new h.Keys();
            else t3.$_terms.keys = null;
            return t3.$_mutateRebuild();
          } }, length: { method(e3) {
            return this.$_addRule({ name: "length", args: { limit: e3 }, operator: "=" });
          }, validate: (e3, t3, { limit: r3 }, { name: s2, operator: n2, args: a2 }) => l.compare(Object.keys(e3).length, r3, n2) ? e3 : t3.error("object." + s2, { limit: a2.limit, value: e3 }), jsonSchema: (e3, t3) => (t3.minProperties = e3.args.limit, t3.maxProperties = e3.args.limit, t3), args: [{ name: "limit", ref: true, assert: l.limit, message: "must be a positive integer" }] }, max: { method(e3) {
            return this.$_addRule({ name: "max", method: "length", args: { limit: e3 }, operator: "<=" });
          }, jsonSchema: (e3, t3) => (t3.maxProperties = e3.args.limit, t3) }, min: { method(e3) {
            return this.$_addRule({ name: "min", method: "length", args: { limit: e3 }, operator: ">=" });
          }, jsonSchema: (e3, t3) => (t3.minProperties = e3.args.limit, t3) }, nand: { method(...e3) {
            ...
            return r3.matches && (o2.matches = this.$_compile(r3.matches), "array" !== o2.matches.type && (o2.matches = o2.matches.$_root.array().items(o2.matches)), a2.$_mutateRegister(o2.matches), a2.$_setFlag("_hasPatternMatch", true, { clone: false })), r3.fallthrough && (o2.fallthrough = true), a2.$_terms.patterns.push(o2), a2.$_mutateRegister(t3), a2;
          } }, ref: { method() {
            ...
            n("string" == typeof e3 || e3 instanceof RegExp, "Rename missing the from argument"), n("string" == typeof t3 || t3 instanceof m, "Invalid rename to argument"), n(t3 !== e3, "Cannot rename key to same name:", e3), l.assertOptions(r3, ["alias", "ignoreUndefined", "override", "multiple"]);
            const a2 = this.clone();
            ...
            return t3 instanceof m && a2.$_mutateRegister(t3), a2.$_terms.renames.push({ from: e3, to: t3, options: s(h.renameDefaults, r3) }), a2;
            ...
            return h.dependency(this, "with", e3, t3, r3);
          } }, without: { method(e3, t3, r3 = {}) {
            return h.dependency(this, "without", e3, t3, r3);
          } }, xor: { method(...e3) {
            ...
            e3.$_terms.keys && (e3.$_terms.keys = new h.Keys(...h.sortKeys(e3.$_terms.keys)));
          }, manifest: { build(e3, t3) {
            if (t3.keys && (e3 = e3.keys(t3.keys)), t3.dependencies) for (const { rel: r3, key: s2 = null, peers: n2, options: a2 } of t3.dependencies) e3 = h.dependency(e3, r3, s2, n2, a2);
            if (t3.patterns) for (const { regex: r3, schema: s2, rule: n2, fallthrough: a2, matches: o2 } of t3.patterns) e3 = e3.pattern(r3 || s2, n2, { fallthrough: a2, matches: o2 });
            ...
            if ("object" == typeof e3) {
              ...
              const r4 = Object.getPrototypeOf(e3), s2 = Object.create(r4);
              return Object.assign(s2, e3), Object.getPrototypeOf(s2) !== r4 && Object.setPrototypeOf(s2, r4), s2;
            }
          ...
          }, h.dependency = function(e3, t3, r3, s2, a2) {
            ...
            null !== r3 && (r3 = c.ref(r3, { separator: o2, ancestor: 0, prefix: false }));
            const u2 = e3.clone();
            return u2.$_terms.dependencies = u2.$_terms.dependencies || [], u2.$_terms.dependencies.push(new h.Dependency(t3, r3, i2, s2, a2)), u2;
          }, h.dependencies = { and(e3, t3, r3, s2, n2) {
            const a2 = [], o2 = [], i2 = t3.peers.length, l2 = h.isPresent(t3.options);
            for (const e4 of t3.peers) false === l2(e4.resolve(r3, s2, n2, null, { shadow: false })) ? a2.push(e4.key) : o2.push(e4.key);
            ...
            const a2 = [], o2 = h.isPresent(t3.options);
            for (const e4 of t3.peers) o2(e4.resolve(r3, s2, n2, null, { shadow: false })) && a2.push(e4.key);
            if (a2.length !== t3.peers.length) return;
            const i2 = t3.paths[0], l2 = t3.paths.slice(1);
            return { code: "object.nand", context: { main: i2, mainWithLabel: h.keysToLabels(e3, i2), peers: l2, peersWithLabels: h.keysToLabels(e3, l2) } };
          }, or(e3, t3, r3, s2, n2) {
            ...
            const i2 = { peers: t3.paths, peersWithLabels: h.keysToLabels(e3, t3.paths) };
            return i2.present = a2, i2.presentWithLabels = h.keysToLabels(e3, a2), { code: "object.oxor", context: i2 };
          }, with(e3, t3, r3, s2, n2) {
            const a2 = h.isPresent(t3.options);
            for (const o2 of t3.peers) if (false === a2(o2.resolve(r3, s2, n2, null, { shadow: false }))) return { code: "object.with", context: { main: t3.key.key, mainWithLabel: h.keysToLabels(e3, t3.key.key), peer: o2.key, peerWithLabel: h.keysToLabels(e3, o2.key) } };
          }, without(e3, t3, r3, s2, n2) {
            const a2 = h.isPresent(t3.options);
            for (const o2 of t3.peers) if (a2(o2.resolve(r3, s2, n2, null, { shadow: false }))) return { code: "object.without", context: { main: t3.key.key, mainWithLabel: h.keysToLabels(e3, t3.key.key), peer: o2.key, peerWithLabel: h.keysToLabels(e3, o2.key) } };
          }, xor(e3, t3, r3, s2, n2) {
            const a2 = [], o2 = h.isPresent(t3.options);
            for (const e4 of t3.peers) o2(e4.resolve(r3, s2, n2, null, { shadow: false })) && a2.push(e4.key);
            if (1 === a2.length) return;
            const i2 = { peers: t3.paths, peersWithLabels: h.keysToLabels(e3, t3.paths) };
            return 0 === a2.length ? { code: "object.missing", context: i2 } : (i2.present = a2, i2.presentWithLabels = h.keysToLabels(e3, a2), { code: "object.xor", context: i2 });
          } }, h.sortKeys = function(e3, t3 = true) {
            const r3 = new o.Sorter();
            for (const s2 of e3) l.tryWithPath(() => r3.add(s2, { after: s2.schema.$_rootReferences(), group: s2.key, manual: t3 }), s2.key);
            try {
              return r3.sort();
            } catch {
              return h.sortKeys(e3, false);
            }
          ...
          }, h.rename = function(e3, t3, r3, s2, n2) {
            const a2 = {};
            for (const o2 of e3.$_terms.renames) {
              const i2 = [], l2 = "string" != typeof o2.from;
              if (l2) for (const e4 of Object.keys(t3)) {
                if (void 0 === t3[e4] && o2.options.ignoreUndefined) continue;
                if (e4 === o2.to) continue;
                const r4 = o2.from.exec(e4);
                r4 && i2.push({ from: e4, to: o2.to, match: r4 });
              }
              else !Object.prototype.hasOwnProperty.call(t3, o2.from) || void 0 === t3[o2.from] && o2.options.ignoreUndefined || i2.push(o2);
              for (const c2 of i2) {
                const i3 = c2.from;
                let u2 = c2.to;
                if (u2 instanceof m && (u2 = u2.render(t3, r3, s2, c2.match)), i3 !== u2) {
                  if (!o2.options.multiple && a2[u2] && (n2.push(e3.$_createError("object.rename.multiple", t3, { from: i3, to: u2, pattern: l2 }, r3, s2)), s2.abortEarly)) return false;
                  if (Object.prototype.hasOwnProperty.call(t3, u2) && !o2.options.override && !a2[u2] && (n2.push(e3.$_createError("object.rename.override", t3, { from: i3, to: u2, pattern: l2 }, r3, s2)), s2.abortEarly)) return false;
                  if ("__proto__" !== u2) void 0 === t3[i3] ? delete t3[u2] : t3[u2] = t3[i3], a2[u2] = true, o2.options.alias || delete t3[i3];
                  else if (n2.push(e3.$_createError("object.rename.proto", t3, { from: i3, to: u2, pattern: l2 }, r3, s2)), s2.abortEarly) return false;
                }
              }
            }
            return true;
          }, h.unknown = function(e3, t3, r3, s2, n2, a2) {
            if (e3.$_terms.patterns) {
              let o2 = false;
              ...
              for (const o3 of r3) {
                ...
                for (let f2 = 0; f2 < e3.$_terms.patterns.length; ++f2) {
                  ...
                  } else if (!m2.schema.$_match(o3, n2.nest(m2.schema, `pattern.${f2}`), a2)) continue;
                  r3.delete(o3);
                  const h2 = n2.localize(u2, l2, { schema: m2.rule, key: o3 }), p = m2.rule.$_validate(c2, h2, a2);
                  if (p.errors) {
                    if (a2.abortEarly) return { value: t3, errors: p.errors };
                    s2.push(...p.errors);
                  }
                  if (m2.matches && i2[f2].push(o3), t3[o3] = p.value, !m2.fallthrough) break;
                }
              }
              if (o2) for (let r4 = 0; r4 < i2.length; ++r4) {
                const o3 = i2[r4];
                if (!o3) continue;
                const c2 = e3.$_terms.patterns[r4].matches, f2 = n2.localize(n2.path, l2, c2), m2 = c2.$_validate(o3, f2, a2);
                if (m2.errors) {
                  const r5 = u.details(m2.errors, { override: false });
                  r5.matches = o3;
                  const i3 = e3.$_createError("object.pattern.match", t3, r5, n2, a2);
            ...
            if (r3.size && (e3.$_terms.keys || e3.$_terms.patterns)) {
              ...
              if (!l.default(e3._flags.unknown, a2.allowUnknown)) for (const o2 of r3) {
                const r4 = n2.localize([...n2.path, o2], []), i2 = e3.$_createError("object.unknown", t3[o2], { child: o2 }, r4, a2, { flags: false });
          ...
          "use strict";
          const { assert: s } = r2(3115), n = r2(680), a = r2(9415), o = r2(3541), i = r2(8013), l = {};
          e2.exports = n.extend({ type: "link", properties: { schemaChain: true }, terms: { link: { init: null, manifest: "single", register: false } }, args: (e3, t3) => e3.ref(t3), jsonSchema(e3, t3, r3, s2) {
            if (!e3.$_terms.link) return t3;
            const { ref: n2 } = e3.$_terms.link[0];
            return "root" === n2.ancestor || n2.ancestor > 0 ? (t3.$ref = `#/${n2.path.map((e4) => `properties/${e4}`).join("/")}`, t3) : (1 === n2.path.length ? t3.$ref = `#/$defs/${n2.path[0]}` : t3.$ref = `#/${n2.path.slice(1).map((e4) => `properties/${e4}`).join("/")}`, t3);
          }, validate(e3, { schema: t3, state: r3, prefs: n2, error: a2 }) {
            s(t3.$_terms.link, "Uninitialized link schema");
            const o2 = t3._flags.maxRecursion;
            if (void 0 !== o2 && r3.schemas.filter((e4) => e4.schema === t3).length > o2) return { value: e3, errors: a2("link.maxRecursion", { limit: o2 }) };
            const i2 = l.generate(t3, e3, r3, n2), c = t3.$_terms.link[0].ref;
            try {
              return i2.$_validate(e3, r3.nest(i2, `link:${c.display}:${i2.type}`), n2);
            } catch (t4) {
              if (!(t4 instanceof RangeError)) throw t4;
              return { value: e3, errors: a2("link.depth") };
            }
          ...
          } }, maxRecursion: { method(e3) {
            return s(Number.isSafeInteger(e3) && e3 >= 1, "limit must be a positive integer"), this.$_setFlag("maxRecursion", e3);
          } } }, messages: { "link.depth": "{{#label}} exceeds maximum recursion depth supported by the runtime", "link.maxRecursion": "{{#label}} exceeds maximum recursion depth of {{#limit}}" }, overrides: { concat(e3) {
            ...
            const a2 = e3.$_terms.link[0].ref, { perspective: o2, path: i2 } = l.perspective(a2, r3);
            l.assert(o2, "which is outside of schema boundaries", a2, e3, r3, s2);
            try {
          ...
          }, l.assert = function(e3, t3, r3, n2, a2, o2) {
            e3 || s(false, `"${i.label(n2._flags, a2, o2)}" contains link reference "${r3.display}" ${t3}`);
          };
        }, 4709(e2, t2, r2) {
          "use strict";
          const { assert: s } = r2(3115), n = r2(680), a = r2(9415), o = { numberRx: /^\s*[+-]?(?:(?:\d+(?:\.\d*)?)|(?:\.\d+))(?:e([+-]?\d+))?\s*$/i, precisionRx: /(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/, exponentialPartRegex: /[eE][+-]?\d+$/, leadingSignAndZerosRegex: /^[+-]?(0*)?/, dotRegex: /\./, trailingZerosRegex: /0+$/, decimalPlaces(e3) {
          ...
          e2.exports = n.extend({ type: "number", flags: { unsafe: { default: false } }, coerce: { from: "string", method(e3, { schema: t3, error: r3 }) {
            if (!e3.match(o.numberRx)) return;
            e3 = e3.trim();
            const s2 = { value: parseFloat(e3) };
            if (0 === s2.value && (s2.value = 0), !t3._flags.unsafe) if (e3.match(/e/i)) {
              if (o.extractSignificantDigits(e3) !== o.extractSignificantDigits(String(s2.value))) return s2.errors = r3("number.unsafe"), s2;
            } else {
              const t4 = s2.value.toString();
              if (t4.match(/e/i)) return s2;
              if (t4 !== o.normalizeDecimal(e3)) return s2.errors = r3("number.unsafe"), s2;
            }
            return s2;
          ...
          }, rules: { compare: { method: false, validate: (e3, t3, { limit: r3 }, { name: s2, operator: n2, args: o2 }) => a.compare(e3, r3, n2) ? e3 : t3.error("number." + s2, { limit: o2.limit, value: e3 }), args: [{ name: "limit", ref: true, assert: a.isNumber, message: "must be a number" }] }, greater: { method(e3) {
            return this.$_addRule({ name: "greater", method: "compare", args: { limit: e3 }, operator: ">" });
          }, jsonSchema: (e3, t3) => (t3.exclusiveMinimum = e3.args.limit, t3) }, integer: { method() {
            return this.$_addRule("integer");
          }, validate: (e3, t3) => Math.trunc(e3) - e3 === 0 ? e3 : t3.error("number.integer"), jsonSchema: (e3, t3) => (t3.type = "integer", t3) }, less: { method(e3) {
            return this.$_addRule({ name: "less", method: "compare", args: { limit: e3 }, operator: "<" });
          }, jsonSchema: (e3, t3) => (t3.exclusiveMaximum = e3.args.limit, t3) }, max: { method(e3) {
            return this.$_addRule({ name: "max", method: "compare", args: { limit: e3 }, operator: "<=" });
          }, jsonSchema: (e3, t3) => (t3.maximum = e3.args.limit, t3) }, min: { method(e3) {
            return this.$_addRule({ name: "min", method: "compare", args: { limit: e3 }, operator: ">=" });
          }, jsonSchema: (e3, t3) => (t3.minimum = e3.args.limit, t3) }, multiple: { method(e3) {
            const t3 = "number" == typeof e3 ? o.decimalPlaces(e3) : null, r3 = Math.pow(10, t3);
            return this.$_addRule({ name: "multiple", args: { base: e3, baseDecimalPlace: t3, pfactor: r3 } });
          }, validate: (e3, t3, { base: r3, baseDecimalPlace: s2, pfactor: n2 }, a2) => o.decimalPlaces(e3) > s2 ? t3.error("number.multiple", { multiple: a2.args.base, value: e3 }) : Math.round(n2 * e3) % Math.round(n2 * r3) === 0 ? e3 : t3.error("number.multiple", { multiple: a2.args.base, value: e3 }), jsonSchema: (e3, t3) => (t3.multipleOf = e3.args.base, t3), args: [{ name: "base", ref: true, assert: (e3) => "number" == typeof e3 && isFinite(e3) && e3 > 0, message: "must be a positive number" }, "baseDecimalPlace", "pfactor"], multi: true }, negative: { method() {
            return this.sign("negative");
          } }, port: { method() {
            return this.$_addRule("port");
          }, validate: (e3, t3) => Number.isSafeInteger(e3) && e3 >= 0 && e3 <= 65535 ? e3 : t3.error("number.port"), jsonSchema: (e3, t3) => (t3.type = "integer", t3.minimum = 0, t3.maximum = 65535, t3) }, positive: { method() {
          ...
          }, validate: (e3, t3, { sign: r3 }) => "negative" === r3 && e3 < 0 || "positive" === r3 && e3 > 0 ? e3 : t3.error(`number.${r3}`), jsonSchema: (e3, t3) => ("positive" === e3.args.sign ? t3.exclusiveMinimum = 0 : t3.exclusiveMaximum = 0, t3) }, unsafe: { method(e3 = true) {
            return s("boolean" == typeof e3, "enabled must be a boolean"), this.$_setFlag("unsafe", e3);
          } } }, cast: { string: { from: (e3) => "number" == typeof e3, to: (e3, t3) => e3.toString() } }, messages: { "number.base": "{{#label}} must be a number", "number.greater": "{{#label}} must be greater than {{#limit}}", "number.infinity": "{{#label}} cannot be infinity", "number.integer": "{{#label}} must be an integer", "number.less": "{{#label}} must be less than {{#limit}}", "number.max": "{{#label}} must be less than or equal to {{#limit}}", "number.min": "{{#label}} must be greater than or equal to {{#limit}}", "number.multiple": "{{#label}} must be a multiple of {{#multiple}}", "number.negative": "{{#label}} must be a negative number", "number.port": "{{#label}} must be a valid port", "number.positive": "{{#label}} must be a positive number", "number.precision": "{{#label}} must have no more than {{#limit}} decimal places", "number.unsafe": "{{#label}} must be a safe number" } }), o.extractSignificantDigits = function(e3) {
            return e3.replace(o.exponentialPartRegex, "").replace(o.dotRegex, "").replace(o.trailingZerosRegex, "").replace(o.leadingSignAndZerosRegex, "");
          ...
          e2.exports = u.extend({ type: "string", flags: { insensitive: { default: false }, truncate: { default: false } }, terms: { replacements: { init: null } }, coerce: { from: "string", method(e3, { schema: t3, state: r3, prefs: s2 }) {
            ...
            if (o2 && o2.args.enabled && (e3 = e3.trim()), t3.$_terms.replacements) for (const r4 of t3.$_terms.replacements) e3 = e3.replace(r4.pattern, r4.replacement);
            const i2 = t3.$_getRule("hex");
            if (i2 && i2.args.options.byteAligned && e3.length % 2 != 0 && (e3 = `0${e3}`), t3.$_getRule("isoDate")) {
            ...
            var n2;
            if (!(null !== (n2 = e3._valids) && void 0 !== n2 && n2.has("") || e3._flags.only)) {
              const r4 = e3.$_getRule("min"), s3 = e3.$_getRule("length");
              (!r4 || r4.args.limit > 0) && (!s3 || s3.args.limit > 0) && (t3.minLength = 1);
            }
            return t3;
          ...
          }, validate: (e3, t3, { options: r3 }) => m.base64Regex[r3.paddingRequired][r3.urlSafe].test(e3) ? e3 : t3.error("string.base64"), jsonSchema: (e3, t3) => (t3.format = "base64", t3) }, case: { method(e3) {
            ...
            if (s2) {
              ...
              if (m.base64Regex[r3.paddingRequired].false.test(s2[3])) return e3;
            }
            return t3.error("string.dataUri");
          }, jsonSchema: (e3, t3) => (t3.format = "data-uri", t3) }, domain: { method(e3) {
            ...
            f.assertOptions(e3, ["allowFullyQualified", "allowUnicode", "allowUnderscore", "ignoreLength", "maxDomainSegments", "minDomainSegments", "multiple", "separator", "tlds"]), s(void 0 === e3.multiple || "boolean" == typeof e3.multiple, "multiple option must be an boolean");
            const t3 = m.addressOptions(e3), r3 = new RegExp(`\\s*[${e3.separator ? n(e3.separator) : ","}]\\s*`);
            return this.$_addRule({ name: "email", args: { options: e3 }, regex: r3, address: t3 });
          }, validate(e3, t3, { options: r3 }, { regex: s2, address: n2 }) {
            const a2 = r3.multiple ? e3.split(s2) : [e3], i2 = [];
            for (const e4 of a2) o(e4, n2) || i2.push(e4);
            return i2.length ? t3.error("string.email", { value: e3, invalids: i2 }) : e3;
          }, jsonSchema: (e3, t3) => (t3.format = "email", t3) }, guid: { alias: "uuid", method(e3 = {}) {
            f.assertOptions(e3, ["version", "separator", "wrapper"]), s(void 0 === e3.wrapper || "boolean" == typeof e3.wrapper || "string" == typeof e3.wrapper && "string" == typeof m.guidBrackets[e3.wrapper], `"wrapper" must be true, false, or one of "${Object.keys(m.guidBrackets).filter(Boolean).join('", "')}"`);
            let t3 = "";
            if (e3.version) {
              ...
              for (let e4 = 0; e4 < r4.length; ++e4) {
                ...
                const o3 = m.guidVersions[a3.toLowerCase()];
                s(o3, "version at position " + e4 + " must be one of " + Object.keys(m.guidVersions).join(", ")), s(!n2.has(o3), "version at position " + e4 + " must not be a duplicate"), t3 += o3, n2.add(o3);
              }
            }
            ...
            let a2, o2;
            void 0 === e3.wrapper ? (a2 = "[\\[{\\(]?", o2 = "[\\]}\\)]?") : true === e3.wrapper ? (a2 = "[\\[{\\(]", o2 = "[\\]}\\)]") : false === e3.wrapper ? (a2 = "", o2 = "") : (a2 = n(e3.wrapper), o2 = n(m.guidBrackets[e3.wrapper]));
            const i2 = new RegExp(`^(${a2})[0-9A-F]{8}(${r3})[0-9A-F]{4}\\2?[${t3 || "0-9A-F"}][0-9A-F]{3}\\2?[${t3 ? "89AB" : "0-9A-F"}][0-9A-F]{3}\\2?[0-9A-F]{12}(${o2})$`, "i");
            return this.$_addRule({ name: "guid", args: { options: e3 }, regex: i2 });
          }, validate(e3, t3, r3, { regex: s2 }) {
            const n2 = s2.exec(e3);
            if (!n2) return t3.error("string.guid");
            const a2 = n2[1], o2 = n2[n2.length - 1];
            return (a2 || o2) && m.guidBrackets[a2] !== o2 ? t3.error("string.guid") : e3;
          }, jsonSchema: (e3, t3) => (t3.format = "uuid", t3) }, hex: { method(e3 = {}) {
          ...
          }, validate: (e3, t3, { options: r3 }) => ("optional" === r3.prefix ? m.hexRegex.withOptionalPrefix : true === r3.prefix ? m.hexRegex.withPrefix : m.hexRegex.withoutPrefix).test(e3) ? r3.byteAligned && e3.length % 2 != 0 ? t3.error("string.hexAlign") : e3 : t3.error("string.hex"), jsonSchema: (e3, t3) => (t3.format = "hex", t3) }, hostname: { method() {
            return this.$_addRule("hostname");
          }, validate: (e3, t3) => a(e3, { minDomainSegments: 1 }) || m.ipRegex.test(e3) ? e3 : t3.error("string.hostname"), jsonSchema: (e3, t3) => (t3.format = "hostname", t3) }, insensitive: { method() {
            return this.$_setFlag("insensitive", true);
          } }, ip: { method(e3 = {}) {
            f.assertOptions(e3, ["cidr", "version"]);
            const { cidr: t3, versions: r3, regex: s2 } = i(e3), n2 = e3.version ? r3 : void 0;
            return this.$_addRule({ name: "ip", args: { options: { cidr: t3, version: n2 } }, regex: s2 });
          }, validate: (e3, t3, { options: r3 }, { regex: s2 }) => s2.test(e3) ? e3 : r3.version ? t3.error("string.ipVersion", { value: e3, cidr: r3.cidr, version: r3.version }) : t3.error("string.ip", { value: e3, cidr: r3.cidr }), jsonSchema(e3, t3) {
            const r3 = e3.args.options.version;
            return r3 && 1 === r3.length ? t3.format = r3[0] : t3.format = "ip", t3;
          } }, isoDate: { method() {
            return this.$_addRule("isoDate");
          }, validate: (e3, { error: t3 }) => m.isoDate(e3) ? e3 : t3("string.isoDate"), jsonSchema: (e3, t3) => (t3.format = "date-time", t3) }, isoDuration: { method() {
            return this.$_addRule("isoDuration");
          }, validate: (e3, t3) => m.isoDurationRegex.test(e3) ? e3 : t3.error("string.isoDuration"), jsonSchema: (e3, t3) => (t3.format = "duration", t3) }, length: { method(e3, t3) {
            return m.length(this, "length", e3, "=", t3);
          }, validate(e3, t3, { limit: r3, encoding: s2 }, { name: n2, operator: a2, args: o2 }) {
            const i2 = !s2 && e3.length;
            return f.compare(i2, r3, a2) ? e3 : t3.error("string." + n2, { limit: o2.limit, value: e3, encoding: s2 });
          }, jsonSchema: (e3, t3) => (t3.minLength = e3.args.limit, t3.maxLength = e3.args.limit, t3), args: [{ name: "limit", ref: true, assert: f.limit, message: "must be a positive integer" }, "encoding"] }, lowercase: { method() {
            return this.case("lower");
          } }, max: { method(e3, t3) {
            return m.length(this, "max", e3, "<=", t3);
          }, jsonSchema: (e3, t3) => (t3.maxLength = e3.args.limit, t3), args: ["limit", "encoding"] }, min: { method(e3, t3) {
            return m.length(this, "min", e3, ">=", t3);
          }, jsonSchema: (e3, t3) => (e3.args.limit > 0 && (t3.minLength = e3.args.limit), t3), args: ["limit", "encoding"] }, normalize: { method(e3 = "NFC") {
          ...
          }, validate: (e3, t3, { regex: r3, options: s2 }, { errorCode: n2 }) => r3.test(e3) ^ s2.invert ? e3 : t3.error(n2, { name: s2.name, regex: r3, value: e3 }), jsonSchema(e3, t3) {
            const r3 = e3.args.regex.source;
            return t3.allOf ? t3.allOf.push({ pattern: r3 }) : void 0 !== t3.pattern ? (t3.allOf = [{ pattern: t3.pattern }, { pattern: r3 }], delete t3.pattern) : t3.pattern = r3, t3;
          ...
          }, validate: (e3, t3) => /^\w+$/.test(e3) ? e3 : t3.error("string.token"), jsonSchema: (e3, t3) => (t3.format = "token", t3) }, trim: { method(e3 = true) {
            ...
            const { regex: t3, scheme: r3 } = l(e3), s2 = e3.domain ? m.addressOptions(e3.domain) : null;
            return this.$_addRule({ name: "uri", args: { options: e3 }, regex: t3, domain: s2, scheme: r3 });
          }, validate(e3, t3, { options: r3 }, { regex: s2, domain: n2, scheme: o2 }) {
            if (["http:/", "https:/"].includes(e3)) return t3.error("string.uri");
            let i2 = s2.exec(e3);
            if (!i2 && t3.prefs.convert && r3.encodeUri) {
              const t4 = encodeURI(e3);
              i2 = s2.exec(t4), i2 && (e3 = t4);
            }
            if (i2) {
              const s3 = i2[1] || i2[2];
              return !n2 || r3.allowRelative && !s3 || a(s3, n2) ? e3 : t3.error("string.domain", { value: s3 });
            }
            return r3.relativeOnly ? t3.error("string.uriRelativeOnly") : r3.scheme ? t3.error("string.uriCustomScheme", { scheme: o2, value: e3 }) : t3.error("string.uri");
          }, jsonSchema: (e3, t3) => (t3.format = "uri", t3) } }, manifest: { build(e3, t3) {
            ...
            return r3 ? true === r3 ? (s(m.tlds, "Built-in TLD list disabled"), Object.assign({}, e3, m.tlds)) : (Array.isArray(r3) && (e3 = Object.assign({}, e3, { tlds: { allow: new Set(r3) } })), s(e3.tlds.allow instanceof Set, "tlds.allow must be an array, Set, or boolean"), m.validateTlds(e3.tlds.allow, "tlds.allow"), e3) : { ...e3, tlds: false };
          ...
          }, m.length = function(e3, t3, r3, n2, a2) {
          ...
          a.Map = class extends Map {
            ...
            return t3.valid(...r3);
          } } }, manifest: { build: (e3, t3) => (t3.map && (e3 = e3.map(t3.map)), e3) }, jsonSchema(e3, t3, r3, s2) {
            const n2 = e3.$_terms.map;
            return n2.size ? { anyOf: Array.from(n2.keys()).map((e4) => ({ const: e4 })) } : {};
          }, messages: { "symbol.base": "{{#label}} must be a symbol", "symbol.map": "{{#label}} must be one of {{#map}}" } });
        }, 1190(e2, t2, r2) {
          "use strict";
          const { assert: s, clone: n, ignore: a, reach: o } = r2(3115), i = r2(9415), l = r2(8013), c = r2(4957), u = { result: /* @__PURE__ */ Symbol("result") };
          t2.entry = function(e3, t3, r3) {
            let n2 = i.defaults;
            r3 && (s(void 0 === r3.warnings, "Cannot override warnings preference in synchronous validation"), s(void 0 === r3.artifacts, "Cannot override artifacts preference in synchronous validation"), n2 = i.preferences(i.defaults, r3));
            ...
            let s2 = i.defaults;
            r3 && (s2 = i.preferences(i.defaults, r3));
            ...
            if (a2.externals.length) {
              ...
              for (const n3 of a2.externals) {
                ...
                let h, p, d = t4;
                const g = f.length ? [t4] : [], y = f.length ? o(e3, f) : e3;
                if (f.length) {
                  h = f[f.length - 1];
                  let e4 = t4;
                ...
                try {
                  const e4 = (e5, t5) => (m || n3.schema).$_createError(e5, d, t5, n3.state, s2), o2 = await n3.method(d, { schema: n3.schema, linked: m, state: n3.state, prefs: r3, original: y, error: e4, errorsArray: u.errorsArray, warn: (e5, t5) => a2.warnings.push((m || n3.schema).$_createError(e5, d, t5, n3.state, s2)), message: (e5, t5) => (m || n3.schema).$_createError("external", d, t5, n3.state, s2, { messages: e5 }) });
                  if (void 0 === o2 || o2 === d) continue;
                  if (o2 instanceof l.Report) {
                    if (a2.tracer.log(n3.schema, n3.state, "rule", "external", "error"), c3.push(o2), s2.abortEarly) break;
                    continue;
                  }
                  if (Array.isArray(o2) && o2[i.symbols.errors]) {
                    if (a2.tracer.log(n3.schema, n3.state, "rule", "external", "error"), c3.push(...o2), s2.abortEarly) break;
                    continue;
                  }
                  p ? (a2.tracer.value(n3.state, "rule", d, o2, "external"), p[h] = o2) : (a2.tracer.value(n3.state, "rule", t4, o2, "external"), t4 = o2);
                } catch (e4) {
          ...
          }, t2.standard = function(e3, r3, s2) {
            const n2 = null == s2 ? void 0 : s2.libraryOptions;
            return r3.isAsync() ? t2.entryAsync(e3, r3, n2) : t2.entry(e3, r3, n2);
          }, u.Mainstay = class {
            constructor(e3, t3, r3) {
            ...
            snapshot() {
              this._snapshots.push({ externals: this.externals.length, warnings: this.warnings.length });
            }
            restore() {
              const e3 = this._snapshots.pop();
              this.externals.length = e3.externals, this.warnings.length = e3.warnings;
            }
            commit() {
              this._snapshots.pop();
            }
          }, u.entry = function(e3, r3, s2) {
            const { tracer: n2, cleanup: a2 } = u.tracer(r3, s2), o2 = s2.debug ? [] : null, i2 = r3._ids._schemaChain ? /* @__PURE__ */ new Map() : null, f = new u.Mainstay(n2, o2, i2), m = r3._ids._schemaChain ? [{ schema: r3 }] : null, h = new c([], [], { mainstay: f, schemas: m }), p = t2.validate(e3, r3, h, s2);
            a2 && r3.$_root.untrace();
            ...
            void 0 !== t3._flags.failover && r3.snapshot();
            const a2 = (n3, a3, o3) => t3.$_createError(n3, e3, a3, o3 || r3, s2), o2 = { original: e3, prefs: s2, schema: t3, state: r3, error: a2, errorsArray: u.errorsArray, warn: (e4, t4, s3) => r3.mainstay.warnings.push(a2(e4, t4, s3)), message: (n3, a3) => t3.$_createError("custom", e3, a3, r3, s2, { messages: n3 }) };
            r3.mainstay.tracer.entry(t3, r3);
            const l2 = t3._definition;
            if (l2.prepare && void 0 !== e3 && s2.convert) {
              const t4 = l2.prepare(e3, o2);
              if (t4) {
                if (r3.mainstay.tracer.value(r3, "prepare", e3, t4.value), t4.errors) return u.finalize(t4.value, [].concat(t4.errors), o2);
                e3 = t4.value;
              }
            }
            if (l2.coerce && void 0 !== e3 && s2.convert && (!l2.coerce.from || l2.coerce.from.includes(typeof e3))) {
              ...
              if (t4) {
                if (r3.mainstay.tracer.value(r3, "coerced", e3, t4.value), t4.errors) return u.finalize(t4.value, [].concat(t4.errors), o2);
                e3 = t4.value;
              }
            }
            const c2 = t3._flags.empty;
            c2 && c2.$_match(u.trim(e3, t3), r3.nest(c2), i.defaults) && (r3.mainstay.tracer.value(r3, "empty", e3, void 0), e3 = void 0);
            ...
            if (void 0 === e3) {
              ...
              if ("required" === f) return u.finalize(e3, [t3.$_createError("any.required", e3, null, r3, s2)], o2);
              if ("optional" === f) {
                if (t3._flags.default !== i.symbols.deepDefault) return u.finalize(e3, null, o2);
                r3.mainstay.tracer.value(r3, "default", e3, {}), e3 = {};
              }
            } else if ("forbidden" === f) return u.finalize(e3, [t3.$_createError("any.unknown", e3, null, r3, s2)], o2);
            const m = [];
            if (t3._valids) {
              const n3 = t3._valids.get(e3, r3, s2, t3._flags.insensitive);
              if (n3) return s2.convert && (r3.mainstay.tracer.value(r3, "valids", e3, n3.value), e3 = n3.value), r3.mainstay.tracer.filter(t3, r3, "valid", n3), u.finalize(e3, null, o2);
              if (t3._flags.only) {
            ...
            for (const o2 of s2._rules) {
              ...
              if (o2._resolve.length) {
                ...
                for (const t4 of o2._resolve) {
                  const r4 = l2.argsByName.get(t4), o3 = f[t4].resolve(e3, n2, a2), u2 = r4.normalize ? r4.normalize(o3) : o3, m2 = i.validateArg(u2, null, r4);
                  if (m2) {
              ...
              if (m.errors) {
                ...
                if (a2.abortEarly) return u.finalize(e3, m.errors, r3);
                t3.push(...m.errors);
            ...
            t3 = t3 || [];
            const { schema: n2, state: a2, prefs: o2 } = r3;
            if (void 0 !== n2._flags.failover) {
              let s2 = false;
              if (t3.length) {
                const n3 = u.default("failover", void 0, t3, r3);
                void 0 !== n3 && (a2.mainstay.tracer.value(a2, "failover", e3, n3), e3 = n3, t3 = [], s2 = true);
              }
              s2 ? a2.restore() : a2.commit();
            }
            ...
            if (n2.$_terms.externals && o2.externals && false !== o2._externals) for (const { method: e4 } of n2.$_terms.externals) a2.mainstay.externals.push({ method: e4, schema: n2, state: a2, label: l.label(n2._flags, a2, o2) });
            const i2 = { value: e3, errors: t3.length ? t3 : null };
            return n2._flags.result && (i2.value = "strip" === n2._flags.result ? void 0 : r3.original, a2.mainstay.tracer.value(a2, n2._flags.result, e3, i2.value), a2.shadow(e3, n2._flags.result)), n2._cache && false !== o2.cache && !n2._refs.length && n2._cache.set(r3.original, i2), void 0 === e3 || i2.errors || void 0 === n2._flags.artifact || (a2.mainstay.artifacts = a2.mainstay.artifacts || /* @__PURE__ */ new Map(), a2.mainstay.artifacts.has(n2._flags.artifact) || a2.mainstay.artifacts.set(n2._flags.artifact, []), a2.mainstay.artifacts.get(n2._flags.artifact).push(a2.path)), i2;
          }, u.prefs = function(e3, t3) {
            const r3 = t3 === i.defaults;
            return r3 && e3._preferences[i.symbols.prefs] ? e3._preferences[i.symbols.prefs] : (t3 = i.preferences(t3, e3._preferences), r3 && (e3._preferences[i.symbols.prefs] = t3), t3);
            ...
            if ("function" == typeof c2) {
              ...
              try {
                ...
                return void r3.push(a2.$_createError(`any.${e3}`, null, { error: t5 }, o2, l2));
              }
            }
          ...
          "use strict";
          const { assert: s, deepEqual: n } = r2(3115), a = r2(9415), o = {};
          e2.exports = o.Values = class {
            ...
            get(e3, t3, r3, s2) {
              ...
              if (t3) for (const a2 of this._refs) {
                const o2 = a2.resolve(e3, t3, r3, null, { in: true });
          ...
          "use strict";
          r2.d(t2, { ipRegex: () => C, isDomainValid: () => h, isEmailValid: () => y, uriRegex: () => T });
          var s = r2(8663);
          ...
          function m(e3, t3 = {}) {
            ...
            if (i.test(e3)) return a("DOMAIN_INVALID_CHARS");
            e3 = (function(e4) {
              e4.includes("%") && (e4 = e4.replace(/%/g, "%25"));
              try {
                return new f(`http://${e4}`).host;
              } catch (t4) {
                return e4;
              }
            })(e3), t3.allowFullyQualified && "." === e3[e3.length - 1] && (e3 = e3.slice(0, -1));
            const r3 = t3.minDomainSegments || 2, s2 = e3.split(".");
            ...
            for (let e4 = 0; e4 < s2.length; ++e4) {
              ...
              if (e4 < s2.length - 1) {
                if (t3.allowUnderscore) {
                  if (!u.test(r4)) return a("DOMAIN_INVALID_CHARS");
                } else if (!c.test(r4)) return a("DOMAIN_INVALID_CHARS");
              } else if (!l.test(r4)) return a("DOMAIN_INVALID_TLDS_CHARS");
            }
            return null;
          }
          function h(e3, t3) {
          ...
          function y(e3, t3) {
            return !(function(e4, t4 = {}) {
              ...
              const r3 = !d.test(e4);
              if (!r3) {
                if (false === t4.allowUnicode) return a("FORBIDDEN_UNICODE");
                e4 = e4.normalize("NFC");
              }
              const s2 = e4.split("@");
              ...
              if (!t4.ignoreLength) {
                ...
                if (g.encode(n2).length > 64) return a("LOCAL_TOO_LONG");
              }
              return (function(e5, t5) {
                ...
                for (const e6 of r4) {
                  ...
                  if (t5) {
                    if (!v.test(e6)) return a("INVALID_LOCAL_CHARS");
                  } else for (const t6 of e6) {
                    if (v.test(t6)) continue;
                    const e7 = b(t6);
                    if (!_.test(e7)) return a("INVALID_LOCAL_CHARS");
                  }
                }
                return null;
              })(n2, r3) || m(o2, t4);
          ...
          function b(e3) {
            return Array.from(g.encode(e3), (e4) => String.fromCharCode(e4)).join("");
          }
          const v = /^[\w!#\$%&'\*\+\-/=\?\^`\{\|\}~]+$/, _ = new RegExp(["(?:[\\xc2-\\xdf][\\x80-\\xbf])", "(?:\\xe0[\\xa0-\\xbf][\\x80-\\xbf])|(?:[\\xe1-\\xec][\\x80-\\xbf]{2})|(?:\\xed[\\x80-\\x9f][\\x80-\\xbf])|(?:[\\xee-\\xef][\\x80-\\xbf]{2})", "(?:\\xf0[\\x90-\\xbf][\\x80-\\xbf]{2})|(?:[\\xf1-\\xf3][\\x80-\\xbf]{3})|(?:\\xf4[\\x80-\\x8f][\\x80-\\xbf]{2})"].join("|"));
          var A = r2(8253), S = r2.n(A), E = r2(8669), O = r2.n(E);
          const R = (function() {
            const e3 = {}, t3 = "\\dA-Fa-f", r3 = "[" + t3 + "]", s2 = "\\w-\\.~", n2 = "!\\$&'\\(\\)\\*\\+,;=", a2 = "%" + t3, o2 = s2 + a2 + n2 + ":@", i2 = "[" + o2 + "]", l2 = "(?:0{0,2}\\d|0?[1-9]\\d|1\\d\\d|2[0-4]\\d|25[0-5])";
            e3.ipv4address = "(?:" + l2 + "\\.){3}" + l2;
            const c2 = r3 + "{1,4}", u2 = "(?:" + c2 + ":" + c2 + "|" + e3.ipv4address + ")", f2 = "(?:" + c2 + ":){6}" + u2, m2 = "::(?:" + c2 + ":){5}" + u2, h2 = "(?:" + c2 + ")?::(?:" + c2 + ":){4}" + u2, p2 = "(?:(?:" + c2 + ":){0,1}" + c2 + ")?::(?:" + c2 + ":){3}" + u2, d2 = "(?:(?:" + c2 + ":){0,2}" + c2 + ")?::(?:" + c2 + ":){2}" + u2, g2 = "(?:(?:" + c2 + ":){0,3}" + c2 + ")?::" + c2 + ":" + u2, y2 = "(?:(?:" + c2 + ":){0,4}" + c2 + ")?::" + u2, b2 = "(?:(?:" + c2 + ":){0,5}" + c2 + ")?::" + c2, v2 = "(?:(?:" + c2 + ":){0,6}" + c2 + ")?::";
            e3.ipv4Cidr = "(?:\\d|[1-2]\\d|3[0-2])", e3.ipv6Cidr = "(?:0{0,2}\\d|0?[1-9]\\d|1[01]\\d|12[0-8])", e3.ipv6address = "(?:" + f2 + "|" + m2 + "|" + h2 + "|" + p2 + "|" + d2 + "|" + g2 + "|" + y2 + "|" + b2 + "|" + v2 + ")", e3.ipvFuture = "v" + r3 + "+\\.[" + s2 + n2 + ":]+", e3.scheme = "[a-zA-Z][a-zA-Z\\d+-\\.]*", e3.schemeRegex = new RegExp(e3.scheme);
            const _2 = "[" + s2 + a2 + n2 + ":]*", A2 = "[" + s2 + a2 + n2 + "]{1,255}", S2 = "(?:\\[(?:" + e3.ipv6address + "|" + e3.ipvFuture + ")\\]|" + e3.ipv4address + "|" + A2 + ")", E2 = "(?:" + _2 + "@)?" + S2 + "(?::\\d*)?", O2 = "(?:" + _2 + "@)?(" + S2 + ")(?::\\d*)?", R2 = i2 + "*", N2 = i2 + "+", I2 = "(?:\\/" + R2 + ")*", w2 = "\\/(?:" + N2 + I2 + ")?", $2 = N2 + I2, T2 = "[" + s2 + a2 + n2 + "@]+" + I2, C2 = "(?:\\/\\/\\/" + R2 + I2 + ")";
            return e3.hierPart = "(?:(?:\\/\\/" + E2 + I2 + ")|" + w2 + "|" + $2 + "|" + C2 + ")", e3.hierPartCapture = "(?:(?:\\/\\/" + O2 + I2 + ")|" + w2 + "|" + $2 + ")", e3.relativeRef = "(?:(?:\\/\\/" + E2 + I2 + ")|" + w2 + "|" + T2 + "|)", e3.relativeRefCapture = "(?:(?:\\/\\/" + O2 + I2 + ")|" + w2 + "|" + T2 + "|)", e3.query = "[" + o2 + "\\/\\?]*(?=#|$)", e3.queryWithSquareBrackets = "[" + o2 + "\\[\\]\\/\\?]*(?=#|$)", e3.fragment = "[" + o2 + "\\/\\?]*", e3;
          })(), N = { v4Cidr: R.ipv4Cidr, v6Cidr: R.ipv6Cidr, ipv4: R.ipv4address, ipv6: R.ipv6address, ipvfuture: R.ipvFuture };
          function I(e3) {
            const t3 = R, r3 = "(?:\\?" + (e3.allowQuerySquareBrackets ? t3.queryWithSquareBrackets : t3.query) + ")?(?:#" + t3.fragment + ")?", s2 = e3.domain ? t3.relativeRefCapture : t3.relativeRef;
            if (e3.relativeOnly) return w(s2 + r3);
            let n2 = "";
            if (e3.scheme) {
              ...
              S()(r4.length >= 1, "scheme must have at least 1 scheme specified");
              const s3 = [];
              for (let e4 = 0; e4 < r4.length; ++e4) {
                const n3 = r4[e4];
                S()(n3 instanceof RegExp || "string" == typeof n3, "scheme at position " + e4 + " must be a RegExp or String"), n3 instanceof RegExp ? s3.push(n3.source.toString()) : (S()(t3.schemeRegex.test(n3), "scheme at position " + e4 + " must be a valid scheme"), s3.push(O()(n3)));
              }
              n2 = s3.join("|");
            }
            const a2 = "(?:" + (n2 ? "(?:" + n2 + ")" : t3.scheme) + ":" + (e3.domain ? t3.hierPartCapture : t3.hierPart) + ")";
            return w((e3.allowRelative ? "(?:" + a2 + "|" + s2 + ")" : a2) + r3, n2);
          }
          function w(e3, t3 = null) {
            return { raw: e3 = `(?=.)(?!https?:/(?:$|[^/]))(?!https?:///)(?!https?:[^/])${e3}`, regex: new RegExp(`^${e3}$`), scheme: t3 };
          }
          const $ = I({});
          function T(e3 = {}) {
            return e3.scheme || e3.allowRelative || e3.relativeOnly || e3.allowQuerySquareBrackets || e3.domain ? I(e3) : $;
          }
          function C(e3 = {}) {
            ...
            Array.isArray(r3) || (r3 = [r3]), S()(r3.length >= 1, "options.version must have at least 1 version specified");
            for (const e4 of r3) S()("string" == typeof e4 && e4 === e4.toLowerCase(), "Invalid options.version value"), S()(["ipv4", "ipv6", "ipvfuture"].includes(e4), "options.version contains unknown version " + e4 + " - must be one of ipv4, ipv6, ipvfuture");
            r3 = Array.from(new Set(r3));
            const s2 = `(?:${r3.map((e4) => {
              if ("forbidden" === t3) return N[e4];
              const r4 = `\\/${"ipv4" === e4 ? N.v4Cidr : N.v6Cidr}`;
              return "required" === t3 ? `${N[e4]}${r4}` : `${N[e4]}(?:${r4})?`;
            }).join("|")})`, n2 = new RegExp(`^${s2}$`);
            return { cidr: t3, versions: r3, regex: n2, raw: s2 };
          }
        }, 679(e2, t2) {
          "use strict";
          const r2 = { operators: ["!", "^", "*", "/", "%", "+", "-", "<", "<=", ">", ">=", "==", "!=", "&&", "||", "??"], operatorCharacters: ["!", "^", "*", "/", "%", "+", "-", "<", "=", ">", "&", "|", "?"], operatorsOrder: [["^"], ["*", "/", "%"], ["+", "-"], ["<", "<=", ">", ">="], ["==", "!="], ["&&"], ["||", "??"]], operatorsPrefix: ["!", "n"], literals: { '"': '"', "`": "`", "'": "'", "[": "]" }, numberRx: /^(?:[0-9]*(\.[0-9]*)?){1}$/, tokenRx: /^[\w\$\#\.\@\:\{\}]+$/, symbol: /* @__PURE__ */ Symbol("formula"), settings: /* @__PURE__ */ Symbol("settings") };
          t2.Parser = class {
            constructor(e3, t3 = {}) {
            ...
            _parse(e3) {
              ...
              const i = (e4) => {
                ...
                if (o || n || e4) {
                  ...
                  } else if (r2.operatorCharacters.includes(n)) i2 && "operator" === i2.type && r2.operators.includes(i2.value + n) ? i2.value += n : s.push({ type: "operator", value: n });
              ...
              for (const t3 of e3) o ? t3 === o ? (i(), o = false) : n += t3 : a ? "(" === t3 ? (n += t3, ++a) : ")" === t3 ? (--a, a ? n += t3 : i(t3)) : n += t3 : t3 in r2.literals ? o = r2.literals[t3] : "(" === t3 ? (i(), ++a) : r2.operatorCharacters.includes(t3) ? (i(), n = t3, i()) : " " !== t3 ? n += t3 : i();
            ...
            _subFormula(e3, s) {
              ...
              if (e3) {
                ...
                for (let s2 = 0; s2 < e3.length; ++s2) {
                  const a2 = e3[s2];
                  o ? (t3 += a2, a2 === o && (o = false)) : a2 in r2.literals && !n2 ? (t3 += a2, o = r2.literals[a2]) : "," !== a2 || n2 ? (t3 += a2, "(" === a2 ? ++n2 : ")" === a2 && --n2) : i();
                }
                i();
              }
            ...
            evaluate(e3) {
              ...
              for (let s = t3.length - 2; s >= 0; --s) {
                ...
                if (n && "operator" === n.type) {
                  const a = t3[s + 1];
                  t3.splice(s + 1, 1);
                  const o = r2.evaluate(a, e3);
                  t3[s] = r2.single(n.value, o);
                }
              }
              return r2.operatorsOrder.forEach((s) => {
                for (let n = 1; n < t3.length - 1; ) if (s.includes(t3[n])) {
                  const s2 = t3[n], a = r2.evaluate(t3[n - 1], e3), o = r2.evaluate(t3[n + 1], e3);
                  t3.splice(n, 2);
                  const i = r2.calculate(s2, a, o);
                  t3[n - 1] = 0 === i ? 0 : i;
                } else n += 2;
              }), r2.evaluate(t3[0], e3);
            }
          ...
          "use strict";
          const s = r2(8253), n = r2(4126), a = r2(9315), o = r2(1528), i = {};
          e2.exports = function(e3, t3, r3 = {}) {
            ...
            for (let r4 of l) {
              ...
              const s2 = o(e3, r4);
              s2 && "object" == typeof s2 ? c.set(s2, u && o(t3, r4) || s2) : u && u.add(r4);
            }
            const f = n(e3, {}, c);
            if (!u) return f;
            for (const e4 of u) i.reachCopy(f, t3, e4);
            const m = void 0 !== r3.nullOverride && r3.nullOverride;
          ...
          "use strict";
          const s = r2(1528), n = r2(3738), a = r2(86), o = { needsProtoHack: /* @__PURE__ */ new Set([n.set, n.map, n.weakSet, n.weakMap]), structuredCloneExists: "function" == typeof structuredClone };
          e2.exports = o.clone = function(e3, t3 = {}, r3 = null) {
            ...
            if (c === e3) return e3;
            if (i && i.set(e3, c), l === n.set) for (const r4 of e3) c.add(s2(r4, t3, i));
            else if (l === n.map) for (const [r4, n2] of e3) c.set(r4, s2(n2, t3, i));
            ...
            for (const r4 of u) {
              ...
              if (o.structuredCloneExists && l === n.error && "stack" === r4) continue;
              const a2 = Object.getOwnPropertyDescriptor(e3, r4);
              a2 ? a2.get || a2.set ? Object.defineProperty(c, r4, a2) : a2.enumerable ? c[r4] = s2(e3[r4], t3, i) : Object.defineProperty(c, r4, { enumerable: false, writable: true, configurable: true, value: s2(e3[r4], t3, i) }) : Object.defineProperty(c, r4, { enumerable: true, writable: true, configurable: true, value: s2(e3[r4], t3, i) });
            }
            return c;
          ...
          }, o.base = function(e3, t3, r3) {
            if (false === r3.prototype) return o.needsProtoHack.has(t3) ? new t3.constructor() : t3 === n.array ? [] : {};
            ...
            if (t3 === n.error && o.structuredCloneExists && (s2 === t3 || Error.isPrototypeOf(s2.constructor))) {
          ...
          e2.exports = function(e3, t3, r3) {
            ...
            const i = n.getSharedType(e3, t3, !!r3.prototype);
            switch (i) {
              case s.buffer:
                return false;
              case s.promise:
            ...
            try {
              return !!n.isDeepEqualObj(i, e3, t3, r3, a);
            } finally {
              a.pop();
            }
            ...
            return true;
          }, n.isDeepEqualObj = function(e3, t3, r3, a, o) {
            ...
            if (e3 === s.array) {
              if (!a.part) {
                ...
                for (let e4 = 0; e4 < t3.length; ++e4) if (!i(t3[e4], r3[e4], a, o)) return false;
                return true;
              }
              for (const e4 of t3) for (const t4 of r3) if (i(e4, t4, a, o)) return true;
            } else if (e3 === s.set) {
              ...
              if (!n.isSetSimpleEqual(t3, r3)) {
                ...
                for (const r4 of Set.prototype.values.call(t3)) {
                  ...
                  let t4 = false;
                  for (const s2 of e4) if (i(r4, s2, a, o)) {
              ...
              for (const [e4, s2] of Map.prototype.entries.call(t3)) {
                ...
                if (!i(s2, Map.prototype.get.call(r3, e4), a, o)) return false;
              }
            } else if (e3 === s.error && (t3.name !== r3.name || t3.message !== r3.message)) return false;
            const m = l(t3), h = l(r3);
            if ((t3 !== m || r3 !== h) && !i(m, h, a, o)) return false;
            const p = u(t3);
            ...
            for (const e4 of p) if (a.skip && a.skip.includes(e4)) void 0 === r3[e4] && ++d;
              ...
              if (!i(t3[e4], r3[e4], a, o)) return false;
            }
              ...
              for (const n2 of e4) {
                ...
                if (null === (g = a.skip) || void 0 === g || !g.includes(n2)) {
                  if (c(t3, n2)) {
                    ...
                    if (!i(t3[n2], r3[n2], a, o)) return false;
          ...
          "use strict";
          t2.applyToDefaults = r2(6084), t2.assert = r2(8253), t2.AssertError = r2(1803), t2.clone = r2(4126), t2.deepEqual = r2(7125), t2.escapeHtml = r2(8121), t2.escapeRegex = r2(8669), t2.ignore = r2(9725), t2.merge = r2(9315), t2.reach = r2(1528);
        }, 9315(e2, t2, r2) {
          "use strict";
          const s = r2(8253), n = r2(4126), a = r2(86), o = {};
          e2.exports = o.merge = function(e3, t3, r3) {
            ...
            for (let s2 = 0; s2 < i.length; ++s2) {
              ...
              if (l && "object" == typeof l) {
                if (e3[a2] === l) continue;
                !e3[a2] || "object" != typeof e3[a2] || Array.isArray(e3[a2]) !== Array.isArray(l) || l instanceof Date || l instanceof RegExp ? e3[a2] = n(l, { symbols: r3.symbols }) : o.merge(e3[a2], l, r3);
          ...
          e2.exports = function(e3, t3, r3) {
            ...
            const o = a ? t3 : t3.split(r3.separator || ".");
            let i = e3;
            for (let e4 = 0; e4 < o.length; ++e4) {
              let a2 = o[e4];
              const l = r3.iterables && n.iterables(i);
              if (Array.isArray(i) || "set" === l) {
                const e5 = Number(a2);
                Number.isInteger(e5) && (a2 = e5 < 0 ? i.length + e5 : e5);
              }
              if (!i || "function" == typeof i && false === r3.functions || !l && void 0 === i[a2]) {
                s(!r3.strict || e4 + 1 === o.length, "Missing segment", a2, "in reach path ", t3), s("object" == typeof i || true === r3.functions || "function" != typeof i, "Invalid segment", a2, "in reach path ", t3), i = r3.default;
                break;
              }
          ...
          t2.Sorter = class {
            ...
            add(e3, t3) {
              var r3, n2, a, o;
              const i = [].concat(null !== (r3 = (t3 = null != t3 ? t3 : {}).before) && void 0 !== r3 ? r3 : []), l = [].concat(null !== (n2 = t3.after) && void 0 !== n2 ? n2 : []), c = null !== (a = t3.group) && void 0 !== a ? a : "?", u = null !== (o = t3.sort) && void 0 !== o ? o : 0;
              s(!i.includes(c), `Item cannot come before itself: ${c}`), s(!i.includes("?"), "Item cannot come before unassociated items"), s(!l.includes(c), `Item cannot come after itself: ${c}`), s(!l.includes("?"), "Item cannot come after unassociated items"), Array.isArray(e3) || (e3 = [e3]);
              for (const t4 of e3) {
                const e4 = { seq: this._items.length, sort: u, before: i, after: l, group: c, node: t4 };
                this._items.push(e4);
              }
              if (!t3.manual) {
                const e4 = this._sort();
            ...
            _sort() {
              ...
              for (const a2 of this._items) {
                var s2;
                const o2 = a2.seq, i2 = a2.group;
                r3[i2] = null !== (s2 = r3[i2]) && void 0 !== s2 ? s2 : [], r3[i2].push(o2), e3[o2] = a2.before;
                for (const e4 of a2.after) {
                  var n2;
                  t3[e4] = null !== (n2 = t3[e4]) && void 0 !== n2 ? n2 : [], t3[e4].push(o2);
                }
              }
              for (const t4 in e3) {
                const s3 = [];
                for (const n3 in e3[t4]) {
                  var a;
                  const o2 = e3[t4][n3];
                  r3[o2] = null !== (a = r3[o2]) && void 0 !== a ? a : [], s3.push(...r3[o2]);
                }
                e3[t4] = s3;
              }
              ...
              for (const t4 in e3) {
                ...
                for (const e4 of r4) {
                  var i;
                  o[e4] = null !== (i = o[e4]) && void 0 !== i ? i : [], o[e4].push(t4);
                }
              }
              const l = {}, c = [];
              for (let e4 = 0; e4 < this._items.length; ++e4) {
                ...
                if (o[e4]) {
                  ...
                  for (let e5 = 0; e5 < this._items.length; ++e5) {
                    ...
                    o[e5] || (o[e5] = []);
                    const r4 = o[e5].length;
                    let s3 = 0;
                    for (let t5 = 0; t5 < r4; ++t5) l[o[e5][t5]] && ++s3;
                    if (s3 === r4) {
                      t4 = e5;
                      break;
                    }
        ...
        return r.n = (e2) => {
          const t2 = e2 && e2.__esModule ? () => e2.default : () => e2;
          return r.d(t2, { a: t2 }), t2;
        }, r.d = (e2, t2) => {
          for (var s in t2) r.o(t2, s) && !r.o(e2, s) && Object.defineProperty(e2, s, { enumerable: true, get: t2[s] });
        }, r.o = (e2, t2) => Object.prototype.hasOwnProperty.call(e2, t2), r(1100);
      })());
    }
  });

  // src/validacoes/frontend.js
  var import_joi = __toESM(require_joi_browser_min(), 1);
  var schemaEmail = import_joi.default.string().trim().email({
    minDomainSegments: 2,
    tlds: {
      allow: false
    }
  ...
  window.validarEmailJoi = function(email) {
    ...
    if (error) {
      return {
        valido: false,
        mensagem: "Informe um endere\xE7o de e-mail v\xE1lido."
      };
    }
    return {
      valido: true,
